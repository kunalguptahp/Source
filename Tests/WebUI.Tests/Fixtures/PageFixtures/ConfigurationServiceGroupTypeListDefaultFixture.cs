...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
    ...
    public class ConfigurationServiceGroupTypeListDefaultFixture : SharedIEInstanceTestFixture
	{
		...
		public void StatusFilterListTest()
		{
			...
			{
                Uri pageUri = ElementsCPSWatinUtility.CreateElementsCPSUri("DataAdmin/ConfigurationServiceGroupTypeList.aspx");
				ie.GoTo(pageUri);
				ie.DoClickFilterAreaExpansionToggle();
				// filter by name ending with "GroupTypeStatus"
