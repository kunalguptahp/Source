...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
	...
	public class ProxyURLListSortingPagingFixture : SharedIEInstanceTestFixture
	{
		...
		/// </remarks>
		[RowTest]
		[Row("Sort$Id", new string[] { "DomainOfA", "DomainOfB", "DomainOfC", "DomainOfD", "DomainOfE" }, 5)]
		[Row("Sort$Name", new string[] { "DomainOfA", "DomainOfB", "DomainOfC", "DomainOfD", "DomainOfE" }, 5)]
