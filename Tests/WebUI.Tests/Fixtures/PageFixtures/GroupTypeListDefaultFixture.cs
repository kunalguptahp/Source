...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
	...
	public class GroupTypeListDefaultFixture : SharedIEInstanceTestFixture
	{

		string[] expectedStringsPrefixes = { "GroupTypeOfA", "GroupTypeOfB", "GroupTypeOfC", "GroupTypeOfD", "GroupTypeOfE" };
		string[] expectedStringsSuffixes = { "Active.GroupTypeStatus", "Inactive.GroupTypeStatus", "Deleted.GroupTypeStatus" };
		...
		public void StatusFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("%GroupTypeStatus");
		...
		public void IDsFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.DoClickFilterAreaExpansionToggle();
				// single name test
				ie.FindListPageTextFieldByControlName(("txtIdList")).TypeText("5");
				ie.FindFilterButton().Click();
				...
				ie.FindListPageTextFieldByControlName(("txtIdList")).TypeText("6,7,8");
				ie.FindFilterButton().Click();
				...
				ElementsCPSWatinUtility.AssertPageBodyHtmlExcludes(expectedStringsSuffixes, ie);
				ie.DoClickFilterAreaExpansionToggle();
				ie.FindListPageTextFieldByControlName(("txtIdList")).TypeText("06");
				ie.FindFilterButton().Click();
				ElementsCPSWatinUtility.AssertPageBodyHtmlContains(expectedStringsPrefixes[1], ie);
		...
		public void NameFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.DoClickFilterAreaExpansionToggle();
				// name "starting with" test
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("GroupTypeOf");
				ie.FindFilterButton().Click();
				...
				ie.FindFilterButton().Click();
				ElementsCPSWatinUtility.AssertPageBodyHtmlContains("There are no group types found", ie);
			}
		}
		...
		public void AllFieldsFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("GroupTypeOfA");
				ie.FindListPageSelectListByControlName(("ddlStatus")).Select("Active");
