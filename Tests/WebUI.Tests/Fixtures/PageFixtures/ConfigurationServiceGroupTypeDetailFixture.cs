...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
    ...
    public class ConfigurationServiceGroupTypeDetailFixture : SharedIEInstanceTestFixture
	{
		[SetUp]
		public void Setup()
		{
		...
		public void AddNewWithOnlyMandatoryTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
                ...
                string[] domainInfo = { "QA_appconfig1", "20100801"};
		...
		public void AddNewWithAllFieldsTest()
		{
			...
			{
                Uri pageUri = ElementsCPSWatinUtility.CreateElementsCPSUri("DataAdmin/ConfigurationServiceGroupTypeList.aspx");
                string[] domainInfo = { "QA_appconfig2", "http://ie.configservice.hp.com", "20100802", "Active" };
		...
		public void EditTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
                ...
                string[] domainInfo = { "GroupTypeOfA_2", "http://ie.configserviceEdit.hp.com", "20100803", "Inactive" };
		...
		public void CancelButtonTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				// Create new button
				ie.FindCreateButton().Click();
                string[] domainInfo = { "GroupTypeOfA_3", "http://ie.configservice.hp.com", "20100804", "Inactive" };
                ie.FindDetailPageTextFieldByControlName("txtName").TypeText(domainInfo[0]);
                ie.FindDetailPageTextFieldByControlName("txtDescription").TypeText(domainInfo[1]);
                ie.FindDetailPageTextFieldByControlName("txtElementsKey").TypeText(domainInfo[2]);
                ie.FindDetailPageSelectListByControlName("ddlStatus").Select(domainInfo[3]);
       ...
       // [Row(true, @" ")]//for space
        ...
        public void KeyInputValidationTest(bool isValidInput, string key)
        {
            EnhancedIE ie = this.SharedIEInstance;
            {
                ...
                Span revWindowsId = ie.Span(Find.ById(Constants.ControlIdDetailPrefix + "revElementsKeyNumber"));
