...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
    ...
    public class ConfigurationServiceItemListDefaultFixture : SharedIEInstanceTestFixture
	{

        string[] expectedStringsPrefixes = { "ItemOfA", "ItemOfB", "ItemOfC", "ItemOfD", "ItemOfE" };
        string[] expectedStringsSuffixes = { "Active.ItemStatus", "Inactive.ItemStatus", "Deleted.ItemStatus" };
		...
		public void StatusFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("%ItemStatus");
		...
		public void NameFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.DoClickFilterAreaExpansionToggle();
				// name "starting with" test
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("ItemOf");
				ie.FindFilterButton().Click();
				...
				ie.FindFilterButton().Click();
				ElementsCPSWatinUtility.AssertPageBodyHtmlContains("There are no items found", ie);
			}
		}
		...
		public void AllFieldsFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				// single name test
				ie.FindListPageTextFieldByControlName(("txtIdList")).TypeText("1");
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("ItemOfA");
				ie.FindListPageSelectListByControlName(("ddlStatus")).Select("Active");
