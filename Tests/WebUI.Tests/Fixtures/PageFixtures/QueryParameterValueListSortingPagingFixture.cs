...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
	...
	public class QueryParameterValueListSortingPagingFixture : SharedIEInstanceTestFixture
	{
		...
		/// </remarks>
		[RowTest]
		[Row("Sort$Id", new string[] { "QueryParameterValueOfA", "QueryParameterValueOfB", "QueryParameterValueOfC", "QueryParameterValueOfD", "QueryParameterValueOfE" }, 5)]
		[Row("Sort$Name", new string[] { "QueryParameterValueOfA", "QueryParameterValueOfB", "QueryParameterValueOfC", "QueryParameterValueOfD", "QueryParameterValueOfE" }, 5)]
