...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
    ...
    public class ConfigurationServiceItemListSortingPagingFixture: SharedIEInstanceTestFixture
	{
        [SetUp]
        public void Setup()
        {
        ...
        [Row("Sort$Name", new string[] { "ItemOfA", "ItemOfB", "ItemOfC", "ItemOfD", "ItemOfE" }, 5)]
        [Row("Sort$ElementsKey", new string[] { "1", "2", "3", "4", "5" }, 5)]
        [Row("Sort$SortOrder", new string[] { "1", "2", "3", "1", "2" }, 5)]
