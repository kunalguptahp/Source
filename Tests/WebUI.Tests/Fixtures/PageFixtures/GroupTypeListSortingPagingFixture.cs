...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
	...
	public class GroupTypeListSortingPagingFixture : SharedIEInstanceTestFixture
	{
		...
		/// </remarks>
		[RowTest]
		[Row("Sort$Id", new string[] { "GroupTypeOfA", "GroupTypeOfB", "GroupTypeOfC", "GroupTypeOfD", "GroupTypeOfE" }, 5)]
