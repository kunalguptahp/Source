...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
	...
	public class QueryParameterListDefaultFixture : SharedIEInstanceTestFixture
	{

		string[] expectedStringsPrefixes = { "QueryParameterOfA", "QueryParameterOfB", "QueryParameterOfC", "QueryParameterOfD", "QueryParameterOfE" };
		string[] expectedStringsSuffixes = { "Active.QueryParameterStatus", "Inactive.QueryParameterStatus", "Deleted.QueryParameterStatus" };
		...
		public void StatusFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("%QueryParameterStatus");
		...
		public void IDsFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.DoClickFilterAreaExpansionToggle();
				// single name test
				ie.FindListPageTextFieldByControlName(("txtIdList")).TypeText("6");
				ie.FindFilterButton().Click();
				...
				ie.FindListPageTextFieldByControlName(("txtIdList")).TypeText("8,9,10");
				ie.FindFilterButton().Click();
				...
				ElementsCPSWatinUtility.AssertPageBodyHtmlExcludes(expectedStringsSuffixes, ie);
				ie.DoClickFilterAreaExpansionToggle();
				ie.FindListPageTextFieldByControlName(("txtIdList")).TypeText("08");
				ie.FindFilterButton().Click();
				ElementsCPSWatinUtility.AssertPageBodyHtmlContains(expectedStringsPrefixes[1], ie);
		...
		public void NameFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.FindFilterButton().Click();
				ElementsCPSWatinUtility.AssertPageBodyHtmlContains("There are no parameters found", ie);
			}
		}
		...
		public void AllFieldsFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("QueryParameterOfA");
				ie.FindListPageSelectListByControlName(("ddlStatus")).Select("Active");
