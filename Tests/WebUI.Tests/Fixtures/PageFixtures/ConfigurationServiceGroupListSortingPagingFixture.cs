...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
    ...
    public class ConfigurationServiceGroupListSortingPagingFixture : SharedIEInstanceTestFixture
	{
        [SetUp]
        public void Setup()
        {
        ...
        [Row("Sort$Name", new string[] { "GroupOfA", "GroupOfB", "GroupOfC", "GroupOfD", "GroupOfE" }, 5)]
        [Row("Sort$Description", new string[] { "Desc1", "Desc2", "Desc3", "Desc4", "Desc5" }, 5)]
        [Row("Sort$ConfigurationServiceGroupStatusName", new string[] { "None", "None", "Active", "Modified", "Cancelled" }, 5)]
        [Row("Sort$ConfigurationServiceGroupTypeName", new string[] { "GroupType9", "GroupTypeOfD", "Active.GroupTypeStatus", "GroupType9", "GroupTypeOfA" }, 5)]
        [Row("Sort$PersonName", new string[] { "Ye, Wei (asiapacific\\mahai)", "Ye, Wei (asiapacific\\mahai)", "Ye, Wei (asiapacific\\mahai)", "Ye, Wei (asiapacific\\mahai)", "Ye, Wei (asiapacific\\mahai)" }, 5)]
        [Row("Sort$TagCount", new string[] { "0", "0", "0", "0", "0" }, 5)]
