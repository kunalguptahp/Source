...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
    ...
    public class ConfigurationServiceGroupTypeListSortingPagingFixture : SharedIEInstanceTestFixture
	{
        [SetUp]
        public void Setup()
        {
        ...
        [Row("Sort$Name", new string[] { "GroupTypeOfA", "GroupTypeOfB", "GroupTypeOfC", "GroupTypeOfD", "GroupTypeOfE" }, 5)]
