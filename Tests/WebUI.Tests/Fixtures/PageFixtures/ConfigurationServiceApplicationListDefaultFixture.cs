...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
    ...
    public class ConfigurationServiceApplicationListDefaultFixture : SharedIEInstanceTestFixture
	{

        string[] expectedStringsPrefixes = { "ApplicationOfA", "ApplicationOfB", "ApplicationOfC", "ApplicationOfD", "ApplicationOfE" };
        string[] expectedStringsSuffixes = { "Active.ApplicationStatus", "Inactive.ApplicationStatus", "Deleted.ApplicationStatus" };
		...
		public void StatusFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("%ApplicationStatus");
		...
		public void NameFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.FindFilterButton().Click();
				ElementsCPSWatinUtility.AssertPageBodyHtmlContains("There are no applications found", ie);
			}
		}
		...
		public void AllFieldsFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				// single name test
				ie.FindListPageTextFieldByControlName(("txtIdList")).TypeText("1");
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("ApplicationOfA");
				ie.FindListPageSelectListByControlName(("ddlStatus")).Select("Active");
