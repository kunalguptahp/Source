...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
	...
	public class PlatformListSortingPagingFixture : SharedIEInstanceTestFixture
	{
		...
		/// </remarks>
		[RowTest]
		[Row("Sort$ValidationPlatform", new string[] { "PlatformOfA", "PlatformOfB", "PlatformOfC", "PlatformOfD", "PlatformOfE" }, 5)]
		[Row("Sort$ProductionPlatform", new string[] { "PlatformOfA", "PlatformOfB", "PlatformOfC", "PlatformOfD", "PlatformOfE" }, 5)]
		[Row("Sort$Id", new string[] { "PlatformOfA", "PlatformOfB", "PlatformOfC", "PlatformOfD", "PlatformOfE" }, 5)]
		[Row("Sort$Name", new string[] { "PlatformOfA", "PlatformOfB", "PlatformOfC", "PlatformOfD", "PlatformOfE" }, 5)]
		...
		/// </remarks>
		[RowTest]
		[Row(1, new string[] { "1", @"PlatformOfA", "2", @"PlatformOfB", "3", @"PlatformOfC", "4", @"PlatformOfD", "5", @"PlatformOfE" })]
		[Row(2, new string[] { "6", @"Active.PlatformStatus", "7", @"Inactive.PlatformStatus", "8", "Deleted.PlatformStatus" })]
