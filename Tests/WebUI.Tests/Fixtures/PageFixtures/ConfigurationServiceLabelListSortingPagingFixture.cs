...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
    ...
    public class ConfigurationServiceLabelListSortingPagingFixture: SharedIEInstanceTestFixture
	{
        [SetUp]
        public void Setup()
        {
		...
		[Row("Sort$Name", new string[] { "LabelOfA", "LabelOfB", "LabelOfC", "LabelOfD", "LabelOfE" }, 5)]
        [Row("Sort$ElementsKey", new string[] { "1", "2", "3", "4", "5" }, 5)]
        [Row("Sort$ConfigurationServiceItemName", new string[] { "ItemOfA", "ItemOfD", "Active.ItemStatus", "Item9", "ItemOfA" }, 5)]
        [Row("Sort$SortOrder", new string[] { "1", "2", "3", "4", "5" }, 5)]
