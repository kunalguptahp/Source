...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
	...
	public class QueryParameterValueListDefaultFixture : SharedIEInstanceTestFixture
	{

		string[] expectedStringsPrefixes = { "QueryParameterValueOfA", "QueryParameterValueOfB", "QueryParameterValueOfC", "QueryParameterValueOfD", "QueryParameterValueOfE" };
		string[] expectedStringsSuffixes = { "Active.QueryParameterValueStatus", "Inactive.QueryParameterValueStatus", "Deleted.QueryParameterValueStatus" };
		...
		public void StatusFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("%QueryParameterValueStatus");
		...
		///// </remarks>
		//[Test]
		//public void ParameterFilterListTest()
		//{
		//    EnhancedIE ie = this.SharedIEInstance;
		//    {
		//        Uri pageUri = ElementsCPSWatinUtility.CreateElementsCPSUri("DataAdmin/QueryParameterValueList.aspx");
		...
		//        ie.DoClickFilterAreaExpansionToggle();
		//        // filter by emails starting with "person."
		//        ie.FindListPageTextFieldByControlName(("txtName")).TypeText("QueryParameterOf");


		//        // Active status test
		//        ie.FindListPageSelectListByControlName(("ddlParameter")).Select("QueryParameterOfA");
		//        ie.FindFilterButton().Click();
		...
		//        ie.DoClickFilterAreaExpansionToggle();
		//        // Active status test
		//        ie.FindListPageSelectListByControlName(("ddlParameter")).Select("- All -");
		//        ie.FindFilterButton().Click();
		//        ElementsCPSWatinUtility.AssertPageBodyHtmlContains(expectedStringsPrefixes, ie);
		//        ie.DoClickFilterAreaExpansionToggle();
		//        // Inactive status test
		//        ie.FindListPageSelectListByControlName(("ddlParameter")).Select("QueryParameterOfB");
		//        ie.FindFilterButton().Click();
		...
		//        ie.DoClickFilterAreaExpansionToggle();
		//        // Deleted status test
		//        ie.FindListPageSelectListByControlName(("ddlParameter")).Select("QueryParameterOfC");
		//        ie.FindFilterButton().Click();
		...
		public void ParameterFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				// Active status test
				ie.FindListPageSelectListByControlName(("ddlParameter")).Select("Active.QueryParameterStatus");
				ie.FindFilterButton().Click();
				ElementsCPSWatinUtility.AssertPageBodyHtmlContains(expectedStringsSuffixes[0], ie);
				ElementsCPSWatinUtility.AssertPageBodyHtmlExcludes(expectedStringsSuffixes[1], ie);
				ElementsCPSWatinUtility.AssertPageBodyHtmlExcludes(expectedStringsSuffixes[2], ie);
				...
				ie.DoClickFilterAreaExpansionToggle();
				// Deleted status test
				ie.FindListPageSelectListByControlName(("ddlParameter")).Select("QueryParameterOfD");
				ie.FindFilterButton().Click();
				ElementsCPSWatinUtility.AssertPageBodyHtmlContains(expectedStringsPrefixes[3], ie);
				ElementsCPSWatinUtility.AssertPageBodyHtmlExcludes(expectedStringsSuffixes, ie);
			}
		...
		public void NameFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.DoClickFilterAreaExpansionToggle();
				// name "starting with" test
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("QueryParameterValueOf");
				ie.FindFilterButton().Click();
				ElementsCPSWatinUtility.AssertPageBodyHtmlContains(expectedStringsPrefixes, ie);
				ie.DoClickFilterAreaExpansionToggle();
				// name "starting with" test
				...
				ie.FindFilterButton().Click();
				ElementsCPSWatinUtility.AssertPageBodyHtmlContains("There are no parameter values found", ie);
			}
		}
		...
		public void AllFieldsFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.FindListPageTextFieldByControlName(("txtIdList")).TypeText("1");
				ie.FindListPageSelectListByControlName(("ddlParameter")).Select("QueryParameterOfA");				
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("QueryParameterValueOfA");
				ie.FindListPageSelectListByControlName(("ddlStatus")).Select("Active");
