...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
	...
	public class RedirectorTypeListDefaultFixture : SharedIEInstanceTestFixture
	{

		string[] expectedStringsPrefixes = { "ProxyURLTypeOfA", "ProxyURLTypeOfB", "ProxyURLTypeOfC", "ProxyURLTypeOfD", "ProxyURLTypeOfE" };
		string[] expectedStringsSuffixes = { "Active.ProxyURLTypeStatus", "Inactive.ProxyURLTypeStatus", "Deleted.ProxyURLTypeStatus" };
		...
		public void StatusFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("%ProxyURLTypeStatus");
		...
		public void NameFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				ie.FindFilterButton().Click();
				ElementsCPSWatinUtility.AssertPageBodyHtmlContains("There are no Redirector Types found", ie);
			}
		}
		...
		public void AllFieldsFilterListTest()
		{
			EnhancedIE ie = this.SharedIEInstance;
			{
				...
				// single name test
				ie.FindListPageTextFieldByControlName(("txtIdList")).TypeText("1");
				ie.FindListPageTextFieldByControlName(("txtName")).TypeText("ProxyURLTypeOfA");
				ie.FindListPageSelectListByControlName(("ddlStatus")).Select("Active");
