...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
	...
	public class NoteTypeListSortingPagingFixture : SharedIEInstanceTestFixture
	{
		...
		/// </remarks>
		[Test]
		[Row("Sort$Id", new string[] { "NoteTypeOfA", "NoteTypeOfB", "NoteTypeOfC", "NoteTypeOfD", "NoteTypeOfE" }, 5)]
		[Row("Sort$Name", new string[] { "NoteTypeOfA", "NoteTypeOfB", "NoteTypeOfC", "NoteTypeOfD", "NoteTypeOfE" }, 5)]
