...
namespace HP.ElementsCPS.Apps.WebUI.Tests.Fixtures.PageFixtures
{
	...
	public class QueryParameterListSortingPagingFixture : SharedIEInstanceTestFixture
	{
		...
		/// </remarks>
		[RowTest]
		[Row("Sort$Id", new string[] { "QueryParameterOfA", "QueryParameterOfB", "QueryParameterOfC", "QueryParameterOfD", "QueryParameterOfE" }, 5)]
		[Row("Sort$Name", new string[] { "QueryParameterOfA", "QueryParameterOfB", "QueryParameterOfC", "QueryParameterOfD", "QueryParameterOfE" }, 5)]
