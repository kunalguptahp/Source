...
{
	/// <summary>
	/// Strongly-typed collection for the ConfigurationServiceGroupType class.
	/// </summary>
    [Serializable]
	public partial class ConfigurationServiceGroupTypeCollection : ActiveList<ConfigurationServiceGroupType, ConfigurationServiceGroupTypeCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceGroupTypeCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(ConfigurationServiceGroupType);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the ConfigurationServiceGroupType table.
	/// </summary>
	[Serializable]
	public partial class ConfigurationServiceGroupType : ActiveRecord<ConfigurationServiceGroupType>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected ConfigurationServiceGroupType(bool useDatabaseDefaults, bool markNew)
		{
		...
		public ConfigurationServiceGroupType() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceGroupType(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceGroupType(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceGroupType(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="ConfigurationServiceGroupType"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private ConfigurationServiceGroupType(ConfigurationServiceGroupType original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(ConfigurationServiceGroupType original)
		{
		...
		/// <param name="original">The <see cref="ConfigurationServiceGroupType"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static ConfigurationServiceGroupType Copy(ConfigurationServiceGroupType original)
		{
			return new ConfigurationServiceGroupType(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ConfigurationServiceGroupType", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("ConfigurationServiceGroupType",schema);
			}
		}
		#endregion
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceGroupCollection().Where(ConfigurationServiceGroup.Columns.ConfigurationServiceGroupTypeId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceItemConfigurationServiceGroupTypeCollection ConfigurationServiceItemConfigurationServiceGroupTypeRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceItemConfigurationServiceGroupTypeCollection().Where(ConfigurationServiceItemConfigurationServiceGroupType.Columns.ConfigurationServiceGroupTypeId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.QueryParameterConfigurationServiceGroupTypeCollection QueryParameterConfigurationServiceGroupTypeRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.QueryParameterConfigurationServiceGroupTypeCollection().Where(QueryParameterConfigurationServiceGroupType.Columns.ConfigurationServiceGroupTypeId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a ConfigurationServiceApplication ActiveRecord object related to this ConfigurationServiceGroupType
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this ConfigurationServiceGroupType
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="ConfigurationServiceGroupType"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("ConfigurationServiceGroupType#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="ConfigurationServiceGroupType"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="ConfigurationServiceGroupType"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="ConfigurationServiceGroupType"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			ConfigurationServiceGroupType instance1 = this;
			ConfigurationServiceGroupType instance2 = obj as ConfigurationServiceGroupType;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="ConfigurationServiceGroupType"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="ConfigurationServiceGroupType"/> to compare.</param>
		/// <param name="instance2">The second <see cref="ConfigurationServiceGroupType"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(ConfigurationServiceGroupType instance1, ConfigurationServiceGroupType instance2)
		{
			if (instance1 == null)
			{
