...
{
	/// <summary>
	/// Strongly-typed collection for the WorkflowSelector class.
	/// </summary>
    [Serializable]
	public partial class WorkflowSelectorCollection : ActiveList<WorkflowSelector, WorkflowSelectorCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowSelectorCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(WorkflowSelector);
		}
	}
	/// <summary>
	...
	/// </summary>
	[Serializable]
	public partial class WorkflowSelector : ActiveRecord<WorkflowSelector>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected WorkflowSelector(bool useDatabaseDefaults, bool markNew)
		{
		...
		public WorkflowSelector() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowSelector(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowSelector(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowSelector(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="WorkflowSelector"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private WorkflowSelector(WorkflowSelector original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(WorkflowSelector original)
		{
		...
		/// <param name="original">The <see cref="WorkflowSelector"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static WorkflowSelector Copy(WorkflowSelector original)
		{
			return new WorkflowSelector(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("WorkflowSelector", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("WorkflowSelector",schema);
			}
		}
		#endregion
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.WorkflowSelectorQueryParameterValueCollection().Where(WorkflowSelectorQueryParameterValue.Columns.WorkflowSelectorId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this WorkflowSelector
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a Workflow ActiveRecord object related to this WorkflowSelector
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="WorkflowSelector"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("WorkflowSelector#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="WorkflowSelector"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="WorkflowSelector"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="WorkflowSelector"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			WorkflowSelector instance1 = this;
			WorkflowSelector instance2 = obj as WorkflowSelector;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="WorkflowSelector"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="WorkflowSelector"/> to compare.</param>
		/// <param name="instance2">The second <see cref="WorkflowSelector"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(WorkflowSelector instance1, WorkflowSelector instance2)
		{
			if (instance1 == null)
			{
