...
namespace HP.ElementsCPS.Data.SubSonicClient{
	...
	/// </summary>
	[Serializable]
	public partial class VwMapProxyURLTypeCollection : ReadOnlyList<VwMapProxyURLType, VwMapProxyURLTypeCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapProxyURLTypeCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(VwMapProxyURLType);
		}
	}
	/// <summary>
	/// Strongly-typed Controller class for the VwMapProxyURLType class.
	/// </summary>
	[Serializable]
	public partial class VwMapProxyURLTypeController : BaseReadOnlyRecordController<VwMapProxyURLType, VwMapProxyURLTypeCollection, VwMapProxyURLTypeController>
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapProxyURLTypeController() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public override TableSchema.Table GetRecordSchema()
		{
			return VwMapProxyURLType.Schema;
		}
	}
	/// <summary>
	/// This is  Read-only wrapper class for the vwMapProxyURLType view.
	/// </summary>
	[Serializable]
	public partial class VwMapProxyURLType : ReadOnlyRecord<VwMapProxyURLType>, IReadOnlyRecord, IRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("vwMapProxyURLType", TableType.View, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("vwMapProxyURLType",schema);
			}
		}
		#endregion
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected VwMapProxyURLType(bool useDatabaseDefaults, bool markNew)
		{
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapProxyURLType() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapProxyURLType(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapProxyURLType(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapProxyURLType(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="VwMapProxyURLType"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private VwMapProxyURLType(VwMapProxyURLType original)
			: this()
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(VwMapProxyURLType original)
		{
		...
		/// <param name="original">The <see cref="VwMapProxyURLType"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static VwMapProxyURLType Copy(VwMapProxyURLType original)
		{
			return new VwMapProxyURLType(original);
		}
		#endregion
		#endregion
		#region Properties
		...
		public int ElementsKey 
		{
			get
			{
				return GetColumnValue<int>("ElementsKey");
			}
			set
			{
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="VwMapProxyURLType"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("VwMapProxyURLType#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="VwMapProxyURLType"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="VwMapProxyURLType"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="VwMapProxyURLType"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			VwMapProxyURLType instance1 = this;
			VwMapProxyURLType instance2 = obj as VwMapProxyURLType;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="VwMapProxyURLType"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="VwMapProxyURLType"/> to compare.</param>
		/// <param name="instance2">The second <see cref="VwMapProxyURLType"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(VwMapProxyURLType instance1, VwMapProxyURLType instance2)
		{
			if (instance1 == null)
			{
