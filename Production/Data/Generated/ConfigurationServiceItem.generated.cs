...
{
	/// <summary>
	/// Strongly-typed collection for the ConfigurationServiceItem class.
	/// </summary>
    [Serializable]
	public partial class ConfigurationServiceItemCollection : ActiveList<ConfigurationServiceItem, ConfigurationServiceItemCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceItemCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(ConfigurationServiceItem);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the ConfigurationServiceItem table.
	/// </summary>
	[Serializable]
	public partial class ConfigurationServiceItem : ActiveRecord<ConfigurationServiceItem>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected ConfigurationServiceItem(bool useDatabaseDefaults, bool markNew)
		{
		...
		public ConfigurationServiceItem() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceItem(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceItem(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceItem(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="ConfigurationServiceItem"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private ConfigurationServiceItem(ConfigurationServiceItem original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(ConfigurationServiceItem original)
		{
		...
		/// <param name="original">The <see cref="ConfigurationServiceItem"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static ConfigurationServiceItem Copy(ConfigurationServiceItem original)
		{
			return new ConfigurationServiceItem(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ConfigurationServiceItem", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				colvarParent.DataType = DbType.Boolean;
				colvarParent.MaxLength = 0;
				colvarParent.AutoIncrement = false;
				colvarParent.IsNullable = false;
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("ConfigurationServiceItem",schema);
			}
		}
		#endregion
		...
		partial void OnParentChanging(bool newValue);
		partial void OnParentChanged(bool oldValue, bool newValue);
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		[XmlAttribute("Parent")]
		[Bindable(true)]
		public bool Parent 
		{
			get { return GetColumnValue<bool>(Columns.Parent); }
			set
			{
				this.OnParentChanging(value);
				this.OnPropertyChanging("Parent", value);
				bool oldValue = this.Parent;
				SetColumnValue(Columns.Parent, value);
				this.OnParentChanged(oldValue, value);
				this.OnPropertyChanged("Parent", oldValue, value);
			}
		}
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceItemConfigurationServiceGroupTypeCollection().Where(ConfigurationServiceItemConfigurationServiceGroupType.Columns.ConfigurationServiceItemId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceLabelCollection ConfigurationServiceLabelRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceLabelCollection().Where(ConfigurationServiceLabel.Columns.ConfigurationServiceItemId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this ConfigurationServiceItem
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="ConfigurationServiceItem"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("ConfigurationServiceItem#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="ConfigurationServiceItem"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="ConfigurationServiceItem"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="ConfigurationServiceItem"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			ConfigurationServiceItem instance1 = this;
			ConfigurationServiceItem instance2 = obj as ConfigurationServiceItem;
			bool isEqual =
				(instance2 != null)
				...
				&& (instance1.Parent == instance2.Parent)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="ConfigurationServiceItem"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="ConfigurationServiceItem"/> to compare.</param>
		/// <param name="instance2">The second <see cref="ConfigurationServiceItem"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(ConfigurationServiceItem instance1, ConfigurationServiceItem instance2)
		{
			if (instance1 == null)
			{
