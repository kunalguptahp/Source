...
namespace HP.ElementsCPS.Data.SubSonicClient{
	/// <summary>
	/// Strongly-typed collection for the VwMapWorkflowApplication class.
	/// </summary>
	[Serializable]
	public partial class VwMapWorkflowApplicationCollection : ReadOnlyList<VwMapWorkflowApplication, VwMapWorkflowApplicationCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapWorkflowApplicationCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(VwMapWorkflowApplication);
		}
	}
	/// <summary>
	/// Strongly-typed Controller class for the VwMapWorkflowApplication class.
	/// </summary>
	[Serializable]
	public partial class VwMapWorkflowApplicationController : BaseReadOnlyRecordController<VwMapWorkflowApplication, VwMapWorkflowApplicationCollection, VwMapWorkflowApplicationController>
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapWorkflowApplicationController() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public override TableSchema.Table GetRecordSchema()
		{
			return VwMapWorkflowApplication.Schema;
		}
	}
	/// <summary>
	/// This is  Read-only wrapper class for the vwMapWorkflowApplication view.
	/// </summary>
	[Serializable]
	public partial class VwMapWorkflowApplication : ReadOnlyRecord<VwMapWorkflowApplication>, IReadOnlyRecord, IRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("vwMapWorkflowApplication", TableType.View, DataService.GetInstance("ElementsCPSDB"));
				...
				TableSchema.TableColumn colvarWorkflowApplicationTypeName = new TableSchema.TableColumn(schema);
				colvarWorkflowApplicationTypeName.ColumnName = "WorkflowApplicationTypeName";
				colvarWorkflowApplicationTypeName.DataType = DbType.String;
				colvarWorkflowApplicationTypeName.MaxLength = 256;
				colvarWorkflowApplicationTypeName.AutoIncrement = false;
				colvarWorkflowApplicationTypeName.IsNullable = false;
				colvarWorkflowApplicationTypeName.IsPrimaryKey = false;
				colvarWorkflowApplicationTypeName.IsForeignKey = false;
				colvarWorkflowApplicationTypeName.IsReadOnly = false;
				
				schema.Columns.Add(colvarWorkflowApplicationTypeName);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["ElementsCPSDB"].AddSchema("vwMapWorkflowApplication",schema);
			}
		}
		#endregion
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected VwMapWorkflowApplication(bool useDatabaseDefaults, bool markNew)
		{
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapWorkflowApplication() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapWorkflowApplication(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapWorkflowApplication(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapWorkflowApplication(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="VwMapWorkflowApplication"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private VwMapWorkflowApplication(VwMapWorkflowApplication original)
			: this()
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(VwMapWorkflowApplication original)
		{
			...
			this.WorkflowApplicationTypeName = original.WorkflowApplicationTypeName;
		...
		/// <param name="original">The <see cref="VwMapWorkflowApplication"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static VwMapWorkflowApplication Copy(VwMapWorkflowApplication original)
		{
			return new VwMapWorkflowApplication(original);
		}
		#endregion
		#endregion
		#region Properties
		...
		partial void OnWorkflowApplicationTypeNameChanging(string newValue);
		partial void OnWorkflowApplicationTypeNameChanged(string oldValue, string newValue);
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		[XmlAttribute("WorkflowApplicationTypeName")]
		[Bindable(true)]
		public string WorkflowApplicationTypeName 
		{
			get
			{
				return GetColumnValue<string>("WorkflowApplicationTypeName");
			}
			set
			{
				this.OnWorkflowApplicationTypeNameChanging(value);
				this.OnPropertyChanging("WorkflowApplicationTypeName", value);
				string oldValue = this.WorkflowApplicationTypeName;
				SetColumnValue("WorkflowApplicationTypeName", value);
				this.OnWorkflowApplicationTypeNameChanged(oldValue, value);
				this.OnPropertyChanged("WorkflowApplicationTypeName", oldValue, value);
			}
		}
		#endregion
		...
		public struct Columns
		{
			...
			public static string WorkflowApplicationTypeName = @"WorkflowApplicationTypeName";
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="VwMapWorkflowApplication"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("VwMapWorkflowApplication#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="VwMapWorkflowApplication"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="VwMapWorkflowApplication"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="VwMapWorkflowApplication"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			VwMapWorkflowApplication instance1 = this;
			VwMapWorkflowApplication instance2 = obj as VwMapWorkflowApplication;
			bool isEqual =
				(instance2 != null)
				...
				&& (instance1.WorkflowApplicationTypeName == instance2.WorkflowApplicationTypeName)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="VwMapWorkflowApplication"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="VwMapWorkflowApplication"/> to compare.</param>
		/// <param name="instance2">The second <see cref="VwMapWorkflowApplication"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(VwMapWorkflowApplication instance1, VwMapWorkflowApplication instance2)
		{
			if (instance1 == null)
			{
