...
{
	/// <summary>
	/// Strongly-typed collection for the ConfigurationServiceApplication class.
	/// </summary>
    [Serializable]
	public partial class ConfigurationServiceApplicationCollection : ActiveList<ConfigurationServiceApplication, ConfigurationServiceApplicationCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceApplicationCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(ConfigurationServiceApplication);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the ConfigurationServiceApplication table.
	/// </summary>
	[Serializable]
	public partial class ConfigurationServiceApplication : ActiveRecord<ConfigurationServiceApplication>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected ConfigurationServiceApplication(bool useDatabaseDefaults, bool markNew)
		{
		...
		public ConfigurationServiceApplication() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceApplication(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceApplication(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceApplication(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="ConfigurationServiceApplication"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private ConfigurationServiceApplication(ConfigurationServiceApplication original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(ConfigurationServiceApplication original)
		{
			...
			this.ConfigurationServiceApplicationTypeId = original.ConfigurationServiceApplicationTypeId;
		...
		/// <param name="original">The <see cref="ConfigurationServiceApplication"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static ConfigurationServiceApplication Copy(ConfigurationServiceApplication original)
		{
			return new ConfigurationServiceApplication(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ConfigurationServiceApplication", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				TableSchema.TableColumn colvarConfigurationServiceApplicationTypeId = new TableSchema.TableColumn(schema);
				colvarConfigurationServiceApplicationTypeId.ColumnName = "ConfigurationServiceApplicationTypeId";
				colvarConfigurationServiceApplicationTypeId.DataType = DbType.Int32;
				colvarConfigurationServiceApplicationTypeId.MaxLength = 0;
				colvarConfigurationServiceApplicationTypeId.AutoIncrement = false;
				colvarConfigurationServiceApplicationTypeId.IsNullable = false;
				colvarConfigurationServiceApplicationTypeId.IsPrimaryKey = false;
				colvarConfigurationServiceApplicationTypeId.IsForeignKey = true;
				colvarConfigurationServiceApplicationTypeId.IsReadOnly = false;
				colvarConfigurationServiceApplicationTypeId.DefaultSetting = @"";
				
					colvarConfigurationServiceApplicationTypeId.ForeignKeyTableName = "ConfigurationServiceApplicationType";
				schema.Columns.Add(colvarConfigurationServiceApplicationTypeId);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["ElementsCPSDB"].AddSchema("ConfigurationServiceApplication",schema);
			}
		}
		#endregion
		...
		partial void OnConfigurationServiceApplicationTypeIdChanging(int newValue);
		partial void OnConfigurationServiceApplicationTypeIdChanged(int oldValue, int newValue);
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		[XmlAttribute("ConfigurationServiceApplicationTypeId")]
		[Bindable(true)]
		public int ConfigurationServiceApplicationTypeId 
		{
			get { return GetColumnValue<int>(Columns.ConfigurationServiceApplicationTypeId); }
			set
			{
				this.OnConfigurationServiceApplicationTypeIdChanging(value);
				this.OnPropertyChanging("ConfigurationServiceApplicationTypeId", value);
				int oldValue = this.ConfigurationServiceApplicationTypeId;
				SetColumnValue(Columns.ConfigurationServiceApplicationTypeId, value);
				this.OnConfigurationServiceApplicationTypeIdChanged(oldValue, value);
				this.OnPropertyChanged("ConfigurationServiceApplicationTypeId", oldValue, value);
			}
		}
		#endregion
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceGroupCollection().Where(ConfigurationServiceGroup.Columns.ConfigurationServiceApplicationId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceGroupTypeCollection ConfigurationServiceGroupTypeRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceGroupTypeCollection().Where(ConfigurationServiceGroupType.Columns.ConfigurationServiceApplicationId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a ConfigurationServiceApplicationType ActiveRecord object related to this ConfigurationServiceApplication
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceApplicationType ConfigurationServiceApplicationType
		{
			get { return HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceApplicationType.FetchByID(this.ConfigurationServiceApplicationTypeId); }
			set { SetColumnValue("ConfigurationServiceApplicationTypeId", value.Id); }
		}
		
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this ConfigurationServiceApplication
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="ConfigurationServiceApplication"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("ConfigurationServiceApplication#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="ConfigurationServiceApplication"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="ConfigurationServiceApplication"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="ConfigurationServiceApplication"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			ConfigurationServiceApplication instance1 = this;
			ConfigurationServiceApplication instance2 = obj as ConfigurationServiceApplication;
			bool isEqual =
				(instance2 != null)
				...
				&& (instance1.ConfigurationServiceApplicationTypeId == instance2.ConfigurationServiceApplicationTypeId)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="ConfigurationServiceApplication"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="ConfigurationServiceApplication"/> to compare.</param>
		/// <param name="instance2">The second <see cref="ConfigurationServiceApplication"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(ConfigurationServiceApplication instance1, ConfigurationServiceApplication instance2)
		{
			if (instance1 == null)
			{
...
*/
	...
	//NOTE: Code Generation: Generation disabled: ObjectDataSource-compatible Update method
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static TableSchema.TableColumn ConfigurationServiceApplicationTypeIdColumn
		{
		...
		public struct Columns
		{
			 ...
			 public static string ConfigurationServiceApplicationTypeId = @"ConfigurationServiceApplicationTypeId";
