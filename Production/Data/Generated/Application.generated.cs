...
{
	/// <summary>
	/// Strongly-typed collection for the Application class.
	/// </summary>
    [Serializable]
	public partial class ApplicationCollection : ActiveList<Application, ApplicationCollection>, IRecordCollection
	{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Application table.
	/// </summary>
	[Serializable]
	public partial class Application : ActiveRecord<Application>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected Application(bool useDatabaseDefaults, bool markNew)
		{
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Application(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Application(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Application(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="Application"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private Application(Application original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(Application original)
		{
		...
		/// <param name="original">The <see cref="Application"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static Application Copy(Application original)
		{
			return new Application(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Application", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("Application",schema);
			}
		}
		#endregion
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.ApplicationRoleCollection ApplicationRoleRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ApplicationRoleCollection().Where(ApplicationRole.Columns.ApplicationId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this Application
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.RoleCollection GetRoleCollection() { return Application.GetRoleCollection(this.Id); }
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static HP.ElementsCPS.Data.SubSonicClient.RoleCollection GetRoleCollection(int varId)
		{
			SubSonic.QueryCommand cmd = new SubSonic.QueryCommand("SELECT * FROM [dbo].[Role] INNER JOIN [Application_Role] ON [Role].[Id] = [Application_Role].[RoleId] WHERE [Application_Role].[ApplicationId] = @ApplicationId", Application.Schema.Provider.Name);
			cmd.AddParameter("@ApplicationId", varId, DbType.Int32);
		...
		public static void SaveRoleMap(int varId, RoleCollection items)
		{
			...
			QueryCommand cmdDel = new QueryCommand("DELETE FROM [Application_Role] WHERE [Application_Role].[ApplicationId] = @ApplicationId", Application.Schema.Provider.Name);
			cmdDel.AddParameter("@ApplicationId", varId, DbType.Int32);
			coll.Add(cmdDel);
			DataService.ExecuteTransaction(coll);
			foreach (Role item in items)
			{
				ApplicationRole varApplicationRole = new ApplicationRole(true);
				varApplicationRole.SetColumnValue("ApplicationId", varId);
				varApplicationRole.SetColumnValue("RoleId", item.GetPrimaryKeyValue());
				varApplicationRole.Save();
			}
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static void SaveRoleMap(int varId, System.Web.UI.WebControls.ListItemCollection itemList) 
		{
			...
			foreach (System.Web.UI.WebControls.ListItem l in itemList) 
			{
				if (l.Selected) 
				{
					ApplicationRole varApplicationRole = new ApplicationRole(true);
					varApplicationRole.SetColumnValue("ApplicationId", varId);
					varApplicationRole.SetColumnValue("RoleId", l.Value);
					varApplicationRole.Save();
				}
			}
		}
		...
		public static void SaveRoleMap(int varId , int[] itemList) 
		{
			...
			foreach (int item in itemList) 
			{
				ApplicationRole varApplicationRole = new ApplicationRole(true);
				varApplicationRole.SetColumnValue("ApplicationId", varId);
				varApplicationRole.SetColumnValue("RoleId", item);
				varApplicationRole.Save();
			}
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="Application"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("Application#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="Application"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="Application"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="Application"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			Application instance1 = this;
			Application instance2 = obj as Application;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="Application"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="Application"/> to compare.</param>
		/// <param name="instance2">The second <see cref="Application"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(Application instance1, Application instance2)
		{
			if (instance1 == null)
			{
