...
namespace HP.ElementsCPS.Data.SubSonicClient{
	...
	/// </summary>
	[Serializable]
	public partial class VwMapJumpstationGroupSelectorCollection : ReadOnlyList<VwMapJumpstationGroupSelector, VwMapJumpstationGroupSelectorCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapJumpstationGroupSelectorCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(VwMapJumpstationGroupSelector);
		}
	}
	/// <summary>
	/// Strongly-typed Controller class for the VwMapJumpstationGroupSelector class.
	/// </summary>
	[Serializable]
	public partial class VwMapJumpstationGroupSelectorController : BaseReadOnlyRecordController<VwMapJumpstationGroupSelector, VwMapJumpstationGroupSelectorCollection, VwMapJumpstationGroupSelectorController>
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapJumpstationGroupSelectorController() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public override TableSchema.Table GetRecordSchema()
		{
			return VwMapJumpstationGroupSelector.Schema;
		}
	}
	/// <summary>
	/// This is  Read-only wrapper class for the vwMapJumpstationGroupSelector view.
	/// </summary>
	[Serializable]
	public partial class VwMapJumpstationGroupSelector : ReadOnlyRecord<VwMapJumpstationGroupSelector>, IReadOnlyRecord, IRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("vwMapJumpstationGroupSelector", TableType.View, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("vwMapJumpstationGroupSelector",schema);
			}
		}
		#endregion
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected VwMapJumpstationGroupSelector(bool useDatabaseDefaults, bool markNew)
		{
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapJumpstationGroupSelector() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapJumpstationGroupSelector(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapJumpstationGroupSelector(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapJumpstationGroupSelector(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="VwMapJumpstationGroupSelector"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private VwMapJumpstationGroupSelector(VwMapJumpstationGroupSelector original)
			: this()
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(VwMapJumpstationGroupSelector original)
		{
		...
		/// <param name="original">The <see cref="VwMapJumpstationGroupSelector"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static VwMapJumpstationGroupSelector Copy(VwMapJumpstationGroupSelector original)
		{
			return new VwMapJumpstationGroupSelector(original);
		}
		#endregion
		#endregion
		#region Properties
		...
		public int JumpstationGroupId 
		{
			get
			{
				return GetColumnValue<int>("JumpstationGroupId");
			}
			set
			{
				...
				SetColumnValue("JumpstationGroupId", value);
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="VwMapJumpstationGroupSelector"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("VwMapJumpstationGroupSelector#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="VwMapJumpstationGroupSelector"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="VwMapJumpstationGroupSelector"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="VwMapJumpstationGroupSelector"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			VwMapJumpstationGroupSelector instance1 = this;
			VwMapJumpstationGroupSelector instance2 = obj as VwMapJumpstationGroupSelector;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="VwMapJumpstationGroupSelector"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="VwMapJumpstationGroupSelector"/> to compare.</param>
		/// <param name="instance2">The second <see cref="VwMapJumpstationGroupSelector"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(VwMapJumpstationGroupSelector instance1, VwMapJumpstationGroupSelector instance2)
		{
			if (instance1 == null)
			{
