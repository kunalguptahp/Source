...
namespace HP.ElementsCPS.Data.SubSonicClient{
	...
	/// </summary>
	[Serializable]
	public partial class VwMapPersonCollection : ReadOnlyList<VwMapPerson, VwMapPersonCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapPersonCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(VwMapPerson);
		}
	}
	/// <summary>
	/// Strongly-typed Controller class for the VwMapPerson class.
	/// </summary>
	[Serializable]
	public partial class VwMapPersonController : BaseReadOnlyRecordController<VwMapPerson, VwMapPersonCollection, VwMapPersonController>
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapPersonController() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public override TableSchema.Table GetRecordSchema()
		{
			return VwMapPerson.Schema;
		}
	}
	/// <summary>
	/// This is  Read-only wrapper class for the vwMapPerson view.
	/// </summary>
	[Serializable]
	public partial class VwMapPerson : ReadOnlyRecord<VwMapPerson>, IReadOnlyRecord, IRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("vwMapPerson", TableType.View, DataService.GetInstance("ElementsCPSDB"));
				...
				colvarTenantGroupId.IsNullable = true;
				colvarTenantGroupId.IsPrimaryKey = false;
				colvarTenantGroupId.IsForeignKey = false;
				colvarTenantGroupId.IsReadOnly = false;
				
				schema.Columns.Add(colvarTenantGroupId);
				
				TableSchema.TableColumn colvarTenantGroupName = new TableSchema.TableColumn(schema);
				colvarTenantGroupName.ColumnName = "TenantGroupName";
				colvarTenantGroupName.DataType = DbType.String;
				colvarTenantGroupName.MaxLength = 256;
				colvarTenantGroupName.AutoIncrement = false;
				colvarTenantGroupName.IsNullable = false;
				colvarTenantGroupName.IsPrimaryKey = false;
				colvarTenantGroupName.IsForeignKey = false;
				colvarTenantGroupName.IsReadOnly = false;
				
				schema.Columns.Add(colvarTenantGroupName);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["ElementsCPSDB"].AddSchema("vwMapPerson",schema);
			}
		}
		#endregion
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected VwMapPerson(bool useDatabaseDefaults, bool markNew)
		{
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapPerson() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapPerson(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapPerson(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapPerson(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="VwMapPerson"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private VwMapPerson(VwMapPerson original)
			: this()
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(VwMapPerson original)
		{
			...
			this.TenantGroupName = original.TenantGroupName;
		...
		/// <param name="original">The <see cref="VwMapPerson"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static VwMapPerson Copy(VwMapPerson original)
		{
			return new VwMapPerson(original);
		}
		#endregion
		#endregion
		#region Properties
		...
		public int? TenantGroupId 
		{
			get
			{
				return GetColumnValue<int?>("TenantGroupId");
			}
			set
			{
				...
				SetColumnValue("TenantGroupId", value);
				this.OnTenantGroupIdChanged(oldValue, value);
				this.OnPropertyChanged("TenantGroupId", oldValue, value);
			}
		}
		partial void OnTenantGroupNameChanging(string newValue);
		partial void OnTenantGroupNameChanged(string oldValue, string newValue);
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		[XmlAttribute("TenantGroupName")]
		[Bindable(true)]
		public string TenantGroupName 
		{
			get
			{
				return GetColumnValue<string>("TenantGroupName");
			}
			set
			{
				this.OnTenantGroupNameChanging(value);
				this.OnPropertyChanging("TenantGroupName", value);
				string oldValue = this.TenantGroupName;
				SetColumnValue("TenantGroupName", value);
				this.OnTenantGroupNameChanged(oldValue, value);
				this.OnPropertyChanged("TenantGroupName", oldValue, value);
			}
		}
		#endregion
		...
		public struct Columns
		{
			...
			public static string TenantGroupName = @"TenantGroupName";
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="VwMapPerson"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("VwMapPerson#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="VwMapPerson"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="VwMapPerson"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="VwMapPerson"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			VwMapPerson instance1 = this;
			VwMapPerson instance2 = obj as VwMapPerson;
			bool isEqual =
				(instance2 != null)
				...
				&& (instance1.TenantGroupName == instance2.TenantGroupName)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="VwMapPerson"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="VwMapPerson"/> to compare.</param>
		/// <param name="instance2">The second <see cref="VwMapPerson"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(VwMapPerson instance1, VwMapPerson instance2)
		{
			if (instance1 == null)
			{
