...
{
	/// <summary>
	/// Strongly-typed collection for the WorkflowSelectorQueryParameterValue class.
	/// </summary>
    [Serializable]
	public partial class WorkflowSelectorQueryParameterValueCollection : ActiveList<WorkflowSelectorQueryParameterValue, WorkflowSelectorQueryParameterValueCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowSelectorQueryParameterValueCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(WorkflowSelectorQueryParameterValue);
		}
	}
	/// <summary>
	...
	/// </summary>
	[Serializable]
	public partial class WorkflowSelectorQueryParameterValue : ActiveRecord<WorkflowSelectorQueryParameterValue>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected WorkflowSelectorQueryParameterValue(bool useDatabaseDefaults, bool markNew)
		{
		...
		public WorkflowSelectorQueryParameterValue() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowSelectorQueryParameterValue(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowSelectorQueryParameterValue(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowSelectorQueryParameterValue(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="WorkflowSelectorQueryParameterValue"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private WorkflowSelectorQueryParameterValue(WorkflowSelectorQueryParameterValue original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(WorkflowSelectorQueryParameterValue original)
		{
		...
		/// <param name="original">The <see cref="WorkflowSelectorQueryParameterValue"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static WorkflowSelectorQueryParameterValue Copy(WorkflowSelectorQueryParameterValue original)
		{
			return new WorkflowSelectorQueryParameterValue(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("WorkflowSelector_QueryParameterValue", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				colvarWorkflowSelectorId.IsForeignKey = true;
				colvarWorkflowSelectorId.IsReadOnly = false;
				colvarWorkflowSelectorId.DefaultSetting = @"";
				
					colvarWorkflowSelectorId.ForeignKeyTableName = "WorkflowSelector";
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("WorkflowSelector_QueryParameterValue",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<int>(Columns.WorkflowSelectorId); }
			set
			{
				...
				SetColumnValue(Columns.WorkflowSelectorId, value);
		...
		/// <summary>
		/// Returns a QueryParameterValue ActiveRecord object related to this WorkflowSelectorQueryParameterValue
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a WorkflowSelector ActiveRecord object related to this WorkflowSelectorQueryParameterValue
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.WorkflowSelector WorkflowSelector
		{
			get { return HP.ElementsCPS.Data.SubSonicClient.WorkflowSelector.FetchByID(this.WorkflowSelectorId); }
			set { SetColumnValue("WorkflowSelectorId", value.Id); }
		}
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="WorkflowSelectorQueryParameterValue"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("WorkflowSelectorQueryParameterValue#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="WorkflowSelectorQueryParameterValue"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="WorkflowSelectorQueryParameterValue"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="WorkflowSelectorQueryParameterValue"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			WorkflowSelectorQueryParameterValue instance1 = this;
			WorkflowSelectorQueryParameterValue instance2 = obj as WorkflowSelectorQueryParameterValue;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="WorkflowSelectorQueryParameterValue"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="WorkflowSelectorQueryParameterValue"/> to compare.</param>
		/// <param name="instance2">The second <see cref="WorkflowSelectorQueryParameterValue"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(WorkflowSelectorQueryParameterValue instance1, WorkflowSelectorQueryParameterValue instance2)
		{
			if (instance1 == null)
			{
...
*/
	...
	//NOTE: Code Generation: Generation disabled: ObjectDataSource-compatible Update method
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static TableSchema.TableColumn WorkflowSelectorIdColumn
		{
