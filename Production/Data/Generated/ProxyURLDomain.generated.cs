...
{
	/// <summary>
	/// Strongly-typed collection for the ProxyURLDomain class.
	/// </summary>
    [Serializable]
	public partial class ProxyURLDomainCollection : ActiveList<ProxyURLDomain, ProxyURLDomainCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLDomainCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(ProxyURLDomain);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the ProxyURLDomain table.
	/// </summary>
	[Serializable]
	public partial class ProxyURLDomain : ActiveRecord<ProxyURLDomain>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected ProxyURLDomain(bool useDatabaseDefaults, bool markNew)
		{
		...
		public ProxyURLDomain() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLDomain(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLDomain(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLDomain(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="ProxyURLDomain"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private ProxyURLDomain(ProxyURLDomain original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(ProxyURLDomain original)
		{
		...
		/// <param name="original">The <see cref="ProxyURLDomain"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static ProxyURLDomain Copy(ProxyURLDomain original)
		{
			return new ProxyURLDomain(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ProxyURLDomain", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				colvarValidationDomain.DefaultSetting = @"";
				colvarValidationDomain.ForeignKeyTableName = "";
				...
				colvarProductionDomain.DefaultSetting = @"";
				colvarProductionDomain.ForeignKeyTableName = "";
				schema.Columns.Add(colvarProductionDomain);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["ElementsCPSDB"].AddSchema("ProxyURLDomain",schema);
			}
		}
		#endregion
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.ProxyURLTypeCollection ProxyURLTypeRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ProxyURLTypeCollection().Where(ProxyURLType.Columns.ProxyURLDomainId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this ProxyURLDomain
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="ProxyURLDomain"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("ProxyURLDomain#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="ProxyURLDomain"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="ProxyURLDomain"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="ProxyURLDomain"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			ProxyURLDomain instance1 = this;
			ProxyURLDomain instance2 = obj as ProxyURLDomain;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="ProxyURLDomain"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="ProxyURLDomain"/> to compare.</param>
		/// <param name="instance2">The second <see cref="ProxyURLDomain"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(ProxyURLDomain instance1, ProxyURLDomain instance2)
		{
			if (instance1 == null)
			{
...
*/
	...
	//NOTE: Code Generation: Generation disabled: ObjectDataSource-compatible Update method
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static TableSchema.TableColumn ValidationDomainColumn
		{
			get { return Schema.Columns[8]; }
		}
        
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static TableSchema.TableColumn ProductionDomainColumn
		{
