...
{
	/// <summary>
	/// Strongly-typed collection for the ProxyURLGroupType class.
	/// </summary>
    [Serializable]
	public partial class ProxyURLGroupTypeCollection : ActiveList<ProxyURLGroupType, ProxyURLGroupTypeCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLGroupTypeCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(ProxyURLGroupType);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the ProxyURLGroupType table.
	/// </summary>
	[Serializable]
	public partial class ProxyURLGroupType : ActiveRecord<ProxyURLGroupType>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected ProxyURLGroupType(bool useDatabaseDefaults, bool markNew)
		{
		...
		public ProxyURLGroupType() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLGroupType(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLGroupType(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLGroupType(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="ProxyURLGroupType"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private ProxyURLGroupType(ProxyURLGroupType original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(ProxyURLGroupType original)
		{
		...
		/// <param name="original">The <see cref="ProxyURLGroupType"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static ProxyURLGroupType Copy(ProxyURLGroupType original)
		{
			return new ProxyURLGroupType(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ProxyURLGroupType", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("ProxyURLGroupType",schema);
			}
		}
		#endregion
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ProxyURLTypeCollection().Where(ProxyURLType.Columns.ProxyURLGroupTypeId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this ProxyURLGroupType
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="ProxyURLGroupType"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("ProxyURLGroupType#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="ProxyURLGroupType"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="ProxyURLGroupType"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="ProxyURLGroupType"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			ProxyURLGroupType instance1 = this;
			ProxyURLGroupType instance2 = obj as ProxyURLGroupType;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="ProxyURLGroupType"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="ProxyURLGroupType"/> to compare.</param>
		/// <param name="instance2">The second <see cref="ProxyURLGroupType"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(ProxyURLGroupType instance1, ProxyURLGroupType instance2)
		{
			if (instance1 == null)
			{
