...
{
	/// <summary>
	/// Strongly-typed collection for the QueryParameterValue class.
	/// </summary>
    [Serializable]
	public partial class QueryParameterValueCollection : ActiveList<QueryParameterValue, QueryParameterValueCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameterValueCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(QueryParameterValue);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the QueryParameterValue table.
	/// </summary>
	[Serializable]
	public partial class QueryParameterValue : ActiveRecord<QueryParameterValue>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected QueryParameterValue(bool useDatabaseDefaults, bool markNew)
		{
		...
		public QueryParameterValue() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameterValue(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameterValue(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameterValue(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="QueryParameterValue"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private QueryParameterValue(QueryParameterValue original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(QueryParameterValue original)
		{
		...
		/// <param name="original">The <see cref="QueryParameterValue"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static QueryParameterValue Copy(QueryParameterValue original)
		{
			return new QueryParameterValue(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("QueryParameterValue", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("QueryParameterValue",schema);
			}
		}
		#endregion
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceGroupSelectorQueryParameterValueCollection ConfigurationServiceGroupSelectorQueryParameterValueRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceGroupSelectorQueryParameterValueCollection().Where(ConfigurationServiceGroupSelectorQueryParameterValue.Columns.QueryParameterValueId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.JumpstationGroupSelectorQueryParameterValueCollection JumpstationGroupSelectorQueryParameterValueRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.JumpstationGroupSelectorQueryParameterValueCollection().Where(JumpstationGroupSelectorQueryParameterValue.Columns.QueryParameterValueId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.ProxyURLQueryParameterValueCollection ProxyURLQueryParameterValueRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ProxyURLQueryParameterValueCollection().Where(ProxyURLQueryParameterValue.Columns.QueryParameterValueId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.WorkflowSelectorQueryParameterValueCollection WorkflowSelectorQueryParameterValueRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.WorkflowSelectorQueryParameterValueCollection().Where(WorkflowSelectorQueryParameterValue.Columns.QueryParameterValueId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a QueryParameter ActiveRecord object related to this QueryParameterValue
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this QueryParameterValue
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="QueryParameterValue"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("QueryParameterValue#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="QueryParameterValue"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="QueryParameterValue"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="QueryParameterValue"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			QueryParameterValue instance1 = this;
			QueryParameterValue instance2 = obj as QueryParameterValue;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="QueryParameterValue"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="QueryParameterValue"/> to compare.</param>
		/// <param name="instance2">The second <see cref="QueryParameterValue"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(QueryParameterValue instance1, QueryParameterValue instance2)
		{
			if (instance1 == null)
			{
