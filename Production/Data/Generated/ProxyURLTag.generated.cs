...
{
	/// <summary>
	/// Strongly-typed collection for the ProxyURLTag class.
	/// </summary>
    [Serializable]
	public partial class ProxyURLTagCollection : ActiveList<ProxyURLTag, ProxyURLTagCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLTagCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(ProxyURLTag);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the ProxyURL_Tag table.
	/// </summary>
	[Serializable]
	public partial class ProxyURLTag : ActiveRecord<ProxyURLTag>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected ProxyURLTag(bool useDatabaseDefaults, bool markNew)
		{
		...
		public ProxyURLTag() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLTag(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLTag(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLTag(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="ProxyURLTag"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private ProxyURLTag(ProxyURLTag original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(ProxyURLTag original)
		{
		...
		/// <param name="original">The <see cref="ProxyURLTag"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static ProxyURLTag Copy(ProxyURLTag original)
		{
			return new ProxyURLTag(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ProxyURL_Tag", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				colvarProxyURLId.IsPrimaryKey = true;
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("ProxyURL_Tag",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a ProxyURL ActiveRecord object related to this ProxyURLTag
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a Tag ActiveRecord object related to this ProxyURLTag
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="ProxyURLTag"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("ProxyURLTag#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="ProxyURLTag"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="ProxyURLTag"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="ProxyURLTag"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			ProxyURLTag instance1 = this;
			ProxyURLTag instance2 = obj as ProxyURLTag;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="ProxyURLTag"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="ProxyURLTag"/> to compare.</param>
		/// <param name="instance2">The second <see cref="ProxyURLTag"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(ProxyURLTag instance1, ProxyURLTag instance2)
		{
			if (instance1 == null)
			{
