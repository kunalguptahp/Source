...
{
	/// <summary>
	/// Strongly-typed collection for the JumpstationGroup class.
	/// </summary>
    [Serializable]
	public partial class JumpstationGroupCollection : ActiveList<JumpstationGroup, JumpstationGroupCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public JumpstationGroupCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(JumpstationGroup);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the JumpstationGroup table.
	/// </summary>
	[Serializable]
	public partial class JumpstationGroup : ActiveRecord<JumpstationGroup>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected JumpstationGroup(bool useDatabaseDefaults, bool markNew)
		{
		...
		public JumpstationGroup() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public JumpstationGroup(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public JumpstationGroup(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public JumpstationGroup(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="JumpstationGroup"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private JumpstationGroup(JumpstationGroup original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(JumpstationGroup original)
		{
		...
		/// <param name="original">The <see cref="JumpstationGroup"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static JumpstationGroup Copy(JumpstationGroup original)
		{
			return new JumpstationGroup(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("JumpstationGroup", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				colvarTargetURL.DefaultSetting = @"";
				colvarTargetURL.ForeignKeyTableName = "";
				...
				colvarJumpstationGroupStatusId.IsForeignKey = true;
				colvarJumpstationGroupStatusId.IsReadOnly = false;
				colvarJumpstationGroupStatusId.DefaultSetting = @"";
				
					colvarJumpstationGroupStatusId.ForeignKeyTableName = "JumpstationGroupStatus";
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("JumpstationGroup",schema);
			}
		}
		#endregion
		...
		public int? Order 
		{
			...
			set
			{
				...
				SetColumnValue(Columns.Order, value);
		...
		{
			get { return GetColumnValue<int>(Columns.JumpstationGroupStatusId); }
			set
			{
				...
				SetColumnValue(Columns.JumpstationGroupStatusId, value);
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.JumpstationGroupTagCollection().Where(JumpstationGroupTag.Columns.JumpstationGroupId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.JumpstationGroupSelectorCollection JumpstationGroupSelectorRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.JumpstationGroupSelectorCollection().Where(JumpstationGroupSelector.Columns.JumpstationGroupId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a AppClient ActiveRecord object related to this JumpstationGroup
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a JumpstationApplication ActiveRecord object related to this JumpstationGroup
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a JumpstationGroupStatus ActiveRecord object related to this JumpstationGroup
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.JumpstationGroupStatus JumpstationGroupStatus
		{
			get { return HP.ElementsCPS.Data.SubSonicClient.JumpstationGroupStatus.FetchByID(this.JumpstationGroupStatusId); }
			set { SetColumnValue("JumpstationGroupStatusId", value.Id); }
		}
		
		/// <summary>
		/// Returns a JumpstationGroupType ActiveRecord object related to this JumpstationGroup
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this JumpstationGroup
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a Person ActiveRecord object related to this JumpstationGroup
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.TagCollection GetTagCollection() { return JumpstationGroup.GetTagCollection(this.Id); }
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static HP.ElementsCPS.Data.SubSonicClient.TagCollection GetTagCollection(int varId)
		{
			SubSonic.QueryCommand cmd = new SubSonic.QueryCommand("SELECT * FROM [dbo].[Tag] INNER JOIN [JumpstationGroup_Tag] ON [Tag].[Id] = [JumpstationGroup_Tag].[TagId] WHERE [JumpstationGroup_Tag].[JumpstationGroupId] = @JumpstationGroupId", JumpstationGroup.Schema.Provider.Name);
			cmd.AddParameter("@JumpstationGroupId", varId, DbType.Int32);
		...
		public static void SaveTagMap(int varId, TagCollection items)
		{
			...
			QueryCommand cmdDel = new QueryCommand("DELETE FROM [JumpstationGroup_Tag] WHERE [JumpstationGroup_Tag].[JumpstationGroupId] = @JumpstationGroupId", JumpstationGroup.Schema.Provider.Name);
			cmdDel.AddParameter("@JumpstationGroupId", varId, DbType.Int32);
			coll.Add(cmdDel);
			DataService.ExecuteTransaction(coll);
			foreach (Tag item in items)
			{
				JumpstationGroupTag varJumpstationGroupTag = new JumpstationGroupTag(true);
				varJumpstationGroupTag.SetColumnValue("JumpstationGroupId", varId);
				varJumpstationGroupTag.SetColumnValue("TagId", item.GetPrimaryKeyValue());
		...
		public static void SaveTagMap(int varId, System.Web.UI.WebControls.ListItemCollection itemList) 
		{
			...
			foreach (System.Web.UI.WebControls.ListItem l in itemList) 
			{
				if (l.Selected) 
				{
					JumpstationGroupTag varJumpstationGroupTag = new JumpstationGroupTag(true);
					varJumpstationGroupTag.SetColumnValue("JumpstationGroupId", varId);
					varJumpstationGroupTag.SetColumnValue("TagId", l.Value);
					varJumpstationGroupTag.Save();
				}
			}
		}
		...
		public static void SaveTagMap(int varId , int[] itemList) 
		{
			...
			foreach (int item in itemList) 
			{
				JumpstationGroupTag varJumpstationGroupTag = new JumpstationGroupTag(true);
				varJumpstationGroupTag.SetColumnValue("JumpstationGroupId", varId);
				varJumpstationGroupTag.SetColumnValue("TagId", item);
				varJumpstationGroupTag.Save();
			}
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="JumpstationGroup"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("JumpstationGroup#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="JumpstationGroup"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="JumpstationGroup"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="JumpstationGroup"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			JumpstationGroup instance1 = this;
			JumpstationGroup instance2 = obj as JumpstationGroup;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="JumpstationGroup"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="JumpstationGroup"/> to compare.</param>
		/// <param name="instance2">The second <see cref="JumpstationGroup"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(JumpstationGroup instance1, JumpstationGroup instance2)
		{
			if (instance1 == null)
			{
...
*/
	...
	//NOTE: Code Generation: Generation disabled: ObjectDataSource-compatible Update method
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static TableSchema.TableColumn TargetURLColumn
		{
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static TableSchema.TableColumn JumpstationGroupStatusIdColumn
		{
