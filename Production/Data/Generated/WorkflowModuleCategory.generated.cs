...
{
	/// <summary>
	/// Strongly-typed collection for the WorkflowModuleCategory class.
	/// </summary>
    [Serializable]
	public partial class WorkflowModuleCategoryCollection : ActiveList<WorkflowModuleCategory, WorkflowModuleCategoryCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowModuleCategoryCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(WorkflowModuleCategory);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the WorkflowModuleCategory table.
	/// </summary>
	[Serializable]
	public partial class WorkflowModuleCategory : ActiveRecord<WorkflowModuleCategory>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected WorkflowModuleCategory(bool useDatabaseDefaults, bool markNew)
		{
		...
		public WorkflowModuleCategory() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowModuleCategory(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowModuleCategory(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowModuleCategory(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="WorkflowModuleCategory"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private WorkflowModuleCategory(WorkflowModuleCategory original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(WorkflowModuleCategory original)
		{
		...
		/// <param name="original">The <see cref="WorkflowModuleCategory"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static WorkflowModuleCategory Copy(WorkflowModuleCategory original)
		{
			return new WorkflowModuleCategory(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("WorkflowModuleCategory", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("WorkflowModuleCategory",schema);
			}
		}
		#endregion
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.WorkflowModuleCollection().Where(WorkflowModule.Columns.WorkflowModuleCategoryId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.WorkflowModuleVersionCollection WorkflowModuleVersionRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.WorkflowModuleVersionCollection().Where(WorkflowModuleVersion.Columns.WorkflowModuleCategoryId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this WorkflowModuleCategory
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="WorkflowModuleCategory"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("WorkflowModuleCategory#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="WorkflowModuleCategory"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="WorkflowModuleCategory"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="WorkflowModuleCategory"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			WorkflowModuleCategory instance1 = this;
			WorkflowModuleCategory instance2 = obj as WorkflowModuleCategory;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="WorkflowModuleCategory"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="WorkflowModuleCategory"/> to compare.</param>
		/// <param name="instance2">The second <see cref="WorkflowModuleCategory"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(WorkflowModuleCategory instance1, WorkflowModuleCategory instance2)
		{
			if (instance1 == null)
			{
