...
{
	/// <summary>
	/// Strongly-typed collection for the JumpstationGroupSelectorQueryParameterValue class.
	/// </summary>
    [Serializable]
	public partial class JumpstationGroupSelectorQueryParameterValueCollection : ActiveList<JumpstationGroupSelectorQueryParameterValue, JumpstationGroupSelectorQueryParameterValueCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public JumpstationGroupSelectorQueryParameterValueCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(JumpstationGroupSelectorQueryParameterValue);
		}
	}
	/// <summary>
	...
	/// </summary>
	[Serializable]
	public partial class JumpstationGroupSelectorQueryParameterValue : ActiveRecord<JumpstationGroupSelectorQueryParameterValue>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected JumpstationGroupSelectorQueryParameterValue(bool useDatabaseDefaults, bool markNew)
		{
		...
		public JumpstationGroupSelectorQueryParameterValue() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public JumpstationGroupSelectorQueryParameterValue(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public JumpstationGroupSelectorQueryParameterValue(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public JumpstationGroupSelectorQueryParameterValue(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="JumpstationGroupSelectorQueryParameterValue"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private JumpstationGroupSelectorQueryParameterValue(JumpstationGroupSelectorQueryParameterValue original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(JumpstationGroupSelectorQueryParameterValue original)
		{
		...
		/// <param name="original">The <see cref="JumpstationGroupSelectorQueryParameterValue"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static JumpstationGroupSelectorQueryParameterValue Copy(JumpstationGroupSelectorQueryParameterValue original)
		{
			return new JumpstationGroupSelectorQueryParameterValue(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("JumpstationGroupSelector_QueryParameterValue", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				colvarJumpstationGroupSelectorId.IsForeignKey = true;
				colvarJumpstationGroupSelectorId.IsReadOnly = false;
				colvarJumpstationGroupSelectorId.DefaultSetting = @"";
				
					colvarJumpstationGroupSelectorId.ForeignKeyTableName = "JumpstationGroupSelector";
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("JumpstationGroupSelector_QueryParameterValue",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<int>(Columns.JumpstationGroupSelectorId); }
			set
			{
				...
				SetColumnValue(Columns.JumpstationGroupSelectorId, value);
		...
		/// <summary>
		/// Returns a JumpstationGroupSelector ActiveRecord object related to this JumpstationGroupSelectorQueryParameterValue
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.JumpstationGroupSelector JumpstationGroupSelector
		{
			get { return HP.ElementsCPS.Data.SubSonicClient.JumpstationGroupSelector.FetchByID(this.JumpstationGroupSelectorId); }
			set { SetColumnValue("JumpstationGroupSelectorId", value.Id); }
		}
		
		/// <summary>
		/// Returns a QueryParameterValue ActiveRecord object related to this JumpstationGroupSelectorQueryParameterValue
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="JumpstationGroupSelectorQueryParameterValue"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("JumpstationGroupSelectorQueryParameterValue#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="JumpstationGroupSelectorQueryParameterValue"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="JumpstationGroupSelectorQueryParameterValue"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="JumpstationGroupSelectorQueryParameterValue"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			JumpstationGroupSelectorQueryParameterValue instance1 = this;
			JumpstationGroupSelectorQueryParameterValue instance2 = obj as JumpstationGroupSelectorQueryParameterValue;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="JumpstationGroupSelectorQueryParameterValue"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="JumpstationGroupSelectorQueryParameterValue"/> to compare.</param>
		/// <param name="instance2">The second <see cref="JumpstationGroupSelectorQueryParameterValue"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(JumpstationGroupSelectorQueryParameterValue instance1, JumpstationGroupSelectorQueryParameterValue instance2)
		{
			if (instance1 == null)
			{
...
*/
	...
	//NOTE: Code Generation: Generation disabled: ObjectDataSource-compatible Update method
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static TableSchema.TableColumn JumpstationGroupSelectorIdColumn
		{
