...
{
	/// <summary>
	/// Strongly-typed collection for the WorkflowApplication class.
	/// </summary>
    [Serializable]
	public partial class WorkflowApplicationCollection : ActiveList<WorkflowApplication, WorkflowApplicationCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowApplicationCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(WorkflowApplication);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the WorkflowApplication table.
	/// </summary>
	[Serializable]
	public partial class WorkflowApplication : ActiveRecord<WorkflowApplication>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected WorkflowApplication(bool useDatabaseDefaults, bool markNew)
		{
		...
		public WorkflowApplication() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowApplication(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowApplication(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowApplication(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="WorkflowApplication"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private WorkflowApplication(WorkflowApplication original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(WorkflowApplication original)
		{
			...
			this.WorkflowApplicationTypeId = original.WorkflowApplicationTypeId;
		...
		/// <param name="original">The <see cref="WorkflowApplication"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static WorkflowApplication Copy(WorkflowApplication original)
		{
			return new WorkflowApplication(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("WorkflowApplication", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				TableSchema.TableColumn colvarWorkflowApplicationTypeId = new TableSchema.TableColumn(schema);
				colvarWorkflowApplicationTypeId.ColumnName = "WorkflowApplicationTypeId";
				colvarWorkflowApplicationTypeId.DataType = DbType.Int32;
				colvarWorkflowApplicationTypeId.MaxLength = 0;
				colvarWorkflowApplicationTypeId.AutoIncrement = false;
				colvarWorkflowApplicationTypeId.IsNullable = false;
				colvarWorkflowApplicationTypeId.IsPrimaryKey = false;
				colvarWorkflowApplicationTypeId.IsForeignKey = true;
				colvarWorkflowApplicationTypeId.IsReadOnly = false;
				colvarWorkflowApplicationTypeId.DefaultSetting = @"";
				
					colvarWorkflowApplicationTypeId.ForeignKeyTableName = "WorkflowApplicationType";
				schema.Columns.Add(colvarWorkflowApplicationTypeId);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["ElementsCPSDB"].AddSchema("WorkflowApplication",schema);
			}
		}
		#endregion
		...
		partial void OnWorkflowApplicationTypeIdChanging(int newValue);
		partial void OnWorkflowApplicationTypeIdChanged(int oldValue, int newValue);
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		[XmlAttribute("WorkflowApplicationTypeId")]
		[Bindable(true)]
		public int WorkflowApplicationTypeId 
		{
			get { return GetColumnValue<int>(Columns.WorkflowApplicationTypeId); }
			set
			{
				this.OnWorkflowApplicationTypeIdChanging(value);
				this.OnPropertyChanging("WorkflowApplicationTypeId", value);
				int oldValue = this.WorkflowApplicationTypeId;
				SetColumnValue(Columns.WorkflowApplicationTypeId, value);
				this.OnWorkflowApplicationTypeIdChanged(oldValue, value);
				this.OnPropertyChanged("WorkflowApplicationTypeId", oldValue, value);
			}
		}
		#endregion
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.WorkflowCollection().Where(Workflow.Columns.WorkflowApplicationId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this WorkflowApplication
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a WorkflowApplicationType ActiveRecord object related to this WorkflowApplication
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.WorkflowApplicationType WorkflowApplicationType
		{
			get { return HP.ElementsCPS.Data.SubSonicClient.WorkflowApplicationType.FetchByID(this.WorkflowApplicationTypeId); }
			set { SetColumnValue("WorkflowApplicationTypeId", value.Id); }
		}
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="WorkflowApplication"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("WorkflowApplication#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="WorkflowApplication"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="WorkflowApplication"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="WorkflowApplication"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			WorkflowApplication instance1 = this;
			WorkflowApplication instance2 = obj as WorkflowApplication;
			bool isEqual =
				(instance2 != null)
				...
				&& (instance1.WorkflowApplicationTypeId == instance2.WorkflowApplicationTypeId)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="WorkflowApplication"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="WorkflowApplication"/> to compare.</param>
		/// <param name="instance2">The second <see cref="WorkflowApplication"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(WorkflowApplication instance1, WorkflowApplication instance2)
		{
			if (instance1 == null)
			{
...
*/
	...
	//NOTE: Code Generation: Generation disabled: ObjectDataSource-compatible Update method
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static TableSchema.TableColumn WorkflowApplicationTypeIdColumn
		{
		...
		public struct Columns
		{
			 ...
			 public static string WorkflowApplicationTypeId = @"WorkflowApplicationTypeId";
