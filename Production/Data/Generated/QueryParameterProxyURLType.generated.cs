...
{
	/// <summary>
	/// Strongly-typed collection for the QueryParameterProxyURLType class.
	/// </summary>
    [Serializable]
	public partial class QueryParameterProxyURLTypeCollection : ActiveList<QueryParameterProxyURLType, QueryParameterProxyURLTypeCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameterProxyURLTypeCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(QueryParameterProxyURLType);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the QueryParameter_ProxyURLType table.
	/// </summary>
	[Serializable]
	public partial class QueryParameterProxyURLType : ActiveRecord<QueryParameterProxyURLType>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected QueryParameterProxyURLType(bool useDatabaseDefaults, bool markNew)
		{
		...
		public QueryParameterProxyURLType() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameterProxyURLType(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameterProxyURLType(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameterProxyURLType(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="QueryParameterProxyURLType"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private QueryParameterProxyURLType(QueryParameterProxyURLType original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(QueryParameterProxyURLType original)
		{
		...
		/// <param name="original">The <see cref="QueryParameterProxyURLType"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static QueryParameterProxyURLType Copy(QueryParameterProxyURLType original)
		{
			return new QueryParameterProxyURLType(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("QueryParameter_ProxyURLType", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("QueryParameter_ProxyURLType",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a ProxyURLType ActiveRecord object related to this QueryParameterProxyURLType
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a QueryParameter ActiveRecord object related to this QueryParameterProxyURLType
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="QueryParameterProxyURLType"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("QueryParameterProxyURLType#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="QueryParameterProxyURLType"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="QueryParameterProxyURLType"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="QueryParameterProxyURLType"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			QueryParameterProxyURLType instance1 = this;
			QueryParameterProxyURLType instance2 = obj as QueryParameterProxyURLType;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="QueryParameterProxyURLType"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="QueryParameterProxyURLType"/> to compare.</param>
		/// <param name="instance2">The second <see cref="QueryParameterProxyURLType"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(QueryParameterProxyURLType instance1, QueryParameterProxyURLType instance2)
		{
			if (instance1 == null)
			{
