...
{
	/// <summary>
	/// Strongly-typed collection for the JumpstationGroupSelector class.
	/// </summary>
    [Serializable]
	public partial class JumpstationGroupSelectorCollection : ActiveList<JumpstationGroupSelector, JumpstationGroupSelectorCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public JumpstationGroupSelectorCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(JumpstationGroupSelector);
		}
	}
	/// <summary>
	...
	/// </summary>
	[Serializable]
	public partial class JumpstationGroupSelector : ActiveRecord<JumpstationGroupSelector>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected JumpstationGroupSelector(bool useDatabaseDefaults, bool markNew)
		{
		...
		public JumpstationGroupSelector() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public JumpstationGroupSelector(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public JumpstationGroupSelector(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public JumpstationGroupSelector(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="JumpstationGroupSelector"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private JumpstationGroupSelector(JumpstationGroupSelector original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(JumpstationGroupSelector original)
		{
		...
		/// <param name="original">The <see cref="JumpstationGroupSelector"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static JumpstationGroupSelector Copy(JumpstationGroupSelector original)
		{
			return new JumpstationGroupSelector(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("JumpstationGroupSelector", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				colvarJumpstationGroupId.IsPrimaryKey = false;
				colvarJumpstationGroupId.IsForeignKey = true;
				colvarJumpstationGroupId.IsReadOnly = false;
				colvarJumpstationGroupId.DefaultSetting = @"";
				
					colvarJumpstationGroupId.ForeignKeyTableName = "JumpstationGroup";
				schema.Columns.Add(colvarJumpstationGroupId);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["ElementsCPSDB"].AddSchema("JumpstationGroupSelector",schema);
			}
		}
		#endregion
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.JumpstationGroupSelectorQueryParameterValueCollection().Where(JumpstationGroupSelectorQueryParameterValue.Columns.JumpstationGroupSelectorId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a JumpstationGroup ActiveRecord object related to this JumpstationGroupSelector
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.JumpstationGroup JumpstationGroup
		{
			get { return HP.ElementsCPS.Data.SubSonicClient.JumpstationGroup.FetchByID(this.JumpstationGroupId); }
			set { SetColumnValue("JumpstationGroupId", value.Id); }
		}
		
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this JumpstationGroupSelector
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="JumpstationGroupSelector"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("JumpstationGroupSelector#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="JumpstationGroupSelector"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="JumpstationGroupSelector"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="JumpstationGroupSelector"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			JumpstationGroupSelector instance1 = this;
			JumpstationGroupSelector instance2 = obj as JumpstationGroupSelector;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="JumpstationGroupSelector"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="JumpstationGroupSelector"/> to compare.</param>
		/// <param name="instance2">The second <see cref="JumpstationGroupSelector"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(JumpstationGroupSelector instance1, JumpstationGroupSelector instance2)
		{
			if (instance1 == null)
			{
