...
{
	/// <summary>
	/// Strongly-typed collection for the ConfigurationServiceGroupSelector class.
	/// </summary>
    [Serializable]
	public partial class ConfigurationServiceGroupSelectorCollection : ActiveList<ConfigurationServiceGroupSelector, ConfigurationServiceGroupSelectorCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceGroupSelectorCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(ConfigurationServiceGroupSelector);
		}
	}
	/// <summary>
	...
	/// </summary>
	[Serializable]
	public partial class ConfigurationServiceGroupSelector : ActiveRecord<ConfigurationServiceGroupSelector>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected ConfigurationServiceGroupSelector(bool useDatabaseDefaults, bool markNew)
		{
		...
		public ConfigurationServiceGroupSelector() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceGroupSelector(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceGroupSelector(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ConfigurationServiceGroupSelector(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="ConfigurationServiceGroupSelector"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private ConfigurationServiceGroupSelector(ConfigurationServiceGroupSelector original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(ConfigurationServiceGroupSelector original)
		{
		...
		/// <param name="original">The <see cref="ConfigurationServiceGroupSelector"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static ConfigurationServiceGroupSelector Copy(ConfigurationServiceGroupSelector original)
		{
			return new ConfigurationServiceGroupSelector(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ConfigurationServiceGroupSelector", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("ConfigurationServiceGroupSelector",schema);
			}
		}
		#endregion
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceGroupSelectorQueryParameterValueCollection().Where(ConfigurationServiceGroupSelectorQueryParameterValue.Columns.ConfigurationServiceGroupSelectorId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a ConfigurationServiceGroup ActiveRecord object related to this ConfigurationServiceGroupSelector
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this ConfigurationServiceGroupSelector
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="ConfigurationServiceGroupSelector"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("ConfigurationServiceGroupSelector#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="ConfigurationServiceGroupSelector"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="ConfigurationServiceGroupSelector"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="ConfigurationServiceGroupSelector"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			ConfigurationServiceGroupSelector instance1 = this;
			ConfigurationServiceGroupSelector instance2 = obj as ConfigurationServiceGroupSelector;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="ConfigurationServiceGroupSelector"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="ConfigurationServiceGroupSelector"/> to compare.</param>
		/// <param name="instance2">The second <see cref="ConfigurationServiceGroupSelector"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(ConfigurationServiceGroupSelector instance1, ConfigurationServiceGroupSelector instance2)
		{
			if (instance1 == null)
			{
