...
{
	/// <summary>
	/// Strongly-typed collection for the QueryParameterConfigurationServiceGroupType class.
	/// </summary>
    [Serializable]
	public partial class QueryParameterConfigurationServiceGroupTypeCollection : ActiveList<QueryParameterConfigurationServiceGroupType, QueryParameterConfigurationServiceGroupTypeCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameterConfigurationServiceGroupTypeCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(QueryParameterConfigurationServiceGroupType);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the QueryParameter_ConfigurationServiceGroupType table.
	/// </summary>
	[Serializable]
	public partial class QueryParameterConfigurationServiceGroupType : ActiveRecord<QueryParameterConfigurationServiceGroupType>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected QueryParameterConfigurationServiceGroupType(bool useDatabaseDefaults, bool markNew)
		{
		...
		public QueryParameterConfigurationServiceGroupType() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameterConfigurationServiceGroupType(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameterConfigurationServiceGroupType(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameterConfigurationServiceGroupType(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="QueryParameterConfigurationServiceGroupType"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private QueryParameterConfigurationServiceGroupType(QueryParameterConfigurationServiceGroupType original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(QueryParameterConfigurationServiceGroupType original)
		{
		...
		/// <param name="original">The <see cref="QueryParameterConfigurationServiceGroupType"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static QueryParameterConfigurationServiceGroupType Copy(QueryParameterConfigurationServiceGroupType original)
		{
			return new QueryParameterConfigurationServiceGroupType(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("QueryParameter_ConfigurationServiceGroupType", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("QueryParameter_ConfigurationServiceGroupType",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a ConfigurationServiceGroupType ActiveRecord object related to this QueryParameterConfigurationServiceGroupType
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		/// <summary>
		/// Returns a QueryParameter ActiveRecord object related to this QueryParameterConfigurationServiceGroupType
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="QueryParameterConfigurationServiceGroupType"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("QueryParameterConfigurationServiceGroupType#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="QueryParameterConfigurationServiceGroupType"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="QueryParameterConfigurationServiceGroupType"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="QueryParameterConfigurationServiceGroupType"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			QueryParameterConfigurationServiceGroupType instance1 = this;
			QueryParameterConfigurationServiceGroupType instance2 = obj as QueryParameterConfigurationServiceGroupType;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="QueryParameterConfigurationServiceGroupType"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="QueryParameterConfigurationServiceGroupType"/> to compare.</param>
		/// <param name="instance2">The second <see cref="QueryParameterConfigurationServiceGroupType"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(QueryParameterConfigurationServiceGroupType instance1, QueryParameterConfigurationServiceGroupType instance2)
		{
			if (instance1 == null)
			{
