...
{
	/// <summary>
	/// Strongly-typed collection for the WorkflowModuleSubCategory class.
	/// </summary>
    [Serializable]
	public partial class WorkflowModuleSubCategoryCollection : ActiveList<WorkflowModuleSubCategory, WorkflowModuleSubCategoryCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowModuleSubCategoryCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(WorkflowModuleSubCategory);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the WorkflowModuleSubCategory table.
	/// </summary>
	[Serializable]
	public partial class WorkflowModuleSubCategory : ActiveRecord<WorkflowModuleSubCategory>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected WorkflowModuleSubCategory(bool useDatabaseDefaults, bool markNew)
		{
		...
		public WorkflowModuleSubCategory() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowModuleSubCategory(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowModuleSubCategory(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public WorkflowModuleSubCategory(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="WorkflowModuleSubCategory"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private WorkflowModuleSubCategory(WorkflowModuleSubCategory original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(WorkflowModuleSubCategory original)
		{
		...
		/// <param name="original">The <see cref="WorkflowModuleSubCategory"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static WorkflowModuleSubCategory Copy(WorkflowModuleSubCategory original)
		{
			return new WorkflowModuleSubCategory(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("WorkflowModuleSubCategory", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("WorkflowModuleSubCategory",schema);
			}
		}
		#endregion
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.WorkflowModuleCollection().Where(WorkflowModule.Columns.WorkflowModuleSubCategoryId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.WorkflowModuleVersionCollection WorkflowModuleVersionRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.WorkflowModuleVersionCollection().Where(WorkflowModuleVersion.Columns.WorkflowModuleSubCategoryId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this WorkflowModuleSubCategory
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="WorkflowModuleSubCategory"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("WorkflowModuleSubCategory#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="WorkflowModuleSubCategory"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="WorkflowModuleSubCategory"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="WorkflowModuleSubCategory"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			WorkflowModuleSubCategory instance1 = this;
			WorkflowModuleSubCategory instance2 = obj as WorkflowModuleSubCategory;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="WorkflowModuleSubCategory"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="WorkflowModuleSubCategory"/> to compare.</param>
		/// <param name="instance2">The second <see cref="WorkflowModuleSubCategory"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(WorkflowModuleSubCategory instance1, WorkflowModuleSubCategory instance2)
		{
			if (instance1 == null)
			{
