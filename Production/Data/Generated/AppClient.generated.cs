...
{
	/// <summary>
	/// Strongly-typed collection for the AppClient class.
	/// </summary>
    [Serializable]
	public partial class AppClientCollection : ActiveList<AppClient, AppClientCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public AppClientCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(AppClient);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the AppClient table.
	/// </summary>
	[Serializable]
	public partial class AppClient : ActiveRecord<AppClient>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected AppClient(bool useDatabaseDefaults, bool markNew)
		{
		...
		public AppClient() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public AppClient(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public AppClient(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public AppClient(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="AppClient"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private AppClient(AppClient original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(AppClient original)
		{
		...
		/// <param name="original">The <see cref="AppClient"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static AppClient Copy(AppClient original)
		{
			return new AppClient(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AppClient", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("AppClient",schema);
			}
		}
		#endregion
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ConfigurationServiceGroupCollection().Where(ConfigurationServiceGroup.Columns.AppClientId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.JumpstationGroupCollection JumpstationGroupRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.JumpstationGroupCollection().Where(JumpstationGroup.Columns.AppClientId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.TenantAppClientCollection TenantAppClientRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.TenantAppClientCollection().Where(TenantAppClient.Columns.AppClientId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.WorkflowCollection WorkflowRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.WorkflowCollection().Where(Workflow.Columns.AppClientId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this AppClient
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.TenantCollection GetTenantCollection() { return AppClient.GetTenantCollection(this.Id); }
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static HP.ElementsCPS.Data.SubSonicClient.TenantCollection GetTenantCollection(int varId)
		{
			SubSonic.QueryCommand cmd = new SubSonic.QueryCommand("SELECT * FROM [dbo].[Tenant] INNER JOIN [Tenant_AppClient] ON [Tenant].[Id] = [Tenant_AppClient].[TenantGroupId] WHERE [Tenant_AppClient].[AppClientId] = @AppClientId", AppClient.Schema.Provider.Name);
			cmd.AddParameter("@AppClientId", varId, DbType.Int32);
			IDataReader rdr = SubSonic.DataService.GetReader(cmd);
			TenantCollection coll = new TenantCollection();
			coll.LoadAndCloseReader(rdr);
			return coll;
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static void SaveTenantMap(int varId, TenantCollection items)
		{
			QueryCommandCollection coll = new SubSonic.QueryCommandCollection();
			//delete out the existing
			QueryCommand cmdDel = new QueryCommand("DELETE FROM [Tenant_AppClient] WHERE [Tenant_AppClient].[AppClientId] = @AppClientId", AppClient.Schema.Provider.Name);
			cmdDel.AddParameter("@AppClientId", varId, DbType.Int32);
			coll.Add(cmdDel);
			DataService.ExecuteTransaction(coll);
			foreach (Tenant item in items)
			{
				TenantAppClient varTenantAppClient = new TenantAppClient(true);
				varTenantAppClient.SetColumnValue("AppClientId", varId);
				varTenantAppClient.SetColumnValue("TenantGroupId", item.GetPrimaryKeyValue());
				varTenantAppClient.Save();
			}
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static void SaveTenantMap(int varId, System.Web.UI.WebControls.ListItemCollection itemList) 
		{
			QueryCommandCollection coll = new SubSonic.QueryCommandCollection();
			//delete out the existing
			 QueryCommand cmdDel = new QueryCommand("DELETE FROM [Tenant_AppClient] WHERE [Tenant_AppClient].[AppClientId] = @AppClientId", AppClient.Schema.Provider.Name);
			...
			foreach (System.Web.UI.WebControls.ListItem l in itemList) 
			{
				if (l.Selected) 
				{
					TenantAppClient varTenantAppClient = new TenantAppClient(true);
					varTenantAppClient.SetColumnValue("AppClientId", varId);
					varTenantAppClient.SetColumnValue("TenantGroupId", l.Value);
					varTenantAppClient.Save();
				}
			}
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static void SaveTenantMap(int varId , int[] itemList) 
		{
			QueryCommandCollection coll = new SubSonic.QueryCommandCollection();
			//delete out the existing
			 QueryCommand cmdDel = new QueryCommand("DELETE FROM [Tenant_AppClient] WHERE [Tenant_AppClient].[AppClientId] = @AppClientId", AppClient.Schema.Provider.Name);
			...
			foreach (int item in itemList) 
			{
				TenantAppClient varTenantAppClient = new TenantAppClient(true);
				varTenantAppClient.SetColumnValue("AppClientId", varId);
				varTenantAppClient.SetColumnValue("TenantGroupId", item);
				varTenantAppClient.Save();
			}
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static void DeleteTenantMap(int varId) 
		{
			QueryCommand cmdDel = new QueryCommand("DELETE FROM [Tenant_AppClient] WHERE [Tenant_AppClient].[AppClientId] = @AppClientId", AppClient.Schema.Provider.Name);
			cmdDel.AddParameter("@AppClientId", varId, DbType.Int32);
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="AppClient"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("AppClient#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="AppClient"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="AppClient"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="AppClient"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			AppClient instance1 = this;
			AppClient instance2 = obj as AppClient;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="AppClient"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="AppClient"/> to compare.</param>
		/// <param name="instance2">The second <see cref="AppClient"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(AppClient instance1, AppClient instance2)
		{
			if (instance1 == null)
			{
