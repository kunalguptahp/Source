...
{
	/// <summary>
	/// Strongly-typed collection for the QueryParameter class.
	/// </summary>
    [Serializable]
	public partial class QueryParameterCollection : ActiveList<QueryParameter, QueryParameterCollection>, IRecordCollection
	{
		...
		{
			return typeof(QueryParameter);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the QueryParameter table.
	/// </summary>
	[Serializable]
	public partial class QueryParameter : ActiveRecord<QueryParameter>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected QueryParameter(bool useDatabaseDefaults, bool markNew)
		{
		...
		public QueryParameter() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameter(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameter(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public QueryParameter(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="QueryParameter"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private QueryParameter(QueryParameter original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(QueryParameter original)
		{
		...
		/// <param name="original">The <see cref="QueryParameter"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static QueryParameter Copy(QueryParameter original)
		{
			return new QueryParameter(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("QueryParameter", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("QueryParameter",schema);
			}
		}
		#endregion
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.QueryParameterProxyURLTypeCollection().Where(QueryParameterProxyURLType.Columns.QueryParameterId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.QueryParameterConfigurationServiceGroupTypeCollection().Where(QueryParameterConfigurationServiceGroupType.Columns.QueryParameterId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.QueryParameterJumpstationGroupTypeCollection().Where(QueryParameterJumpstationGroupType.Columns.QueryParameterId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.QueryParameterWorkflowTypeCollection QueryParameterWorkflowTypeRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.QueryParameterWorkflowTypeCollection().Where(QueryParameterWorkflowType.Columns.QueryParameterId, Id).Load();
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public HP.ElementsCPS.Data.SubSonicClient.QueryParameterValueCollection QueryParameterValueRecords()
		{
			return new HP.ElementsCPS.Data.SubSonicClient.QueryParameterValueCollection().Where(QueryParameterValue.Columns.QueryParameterId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a RowStatus ActiveRecord object related to this QueryParameter
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="QueryParameter"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("QueryParameter#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="QueryParameter"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="QueryParameter"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="QueryParameter"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			QueryParameter instance1 = this;
			QueryParameter instance2 = obj as QueryParameter;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="QueryParameter"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="QueryParameter"/> to compare.</param>
		/// <param name="instance2">The second <see cref="QueryParameter"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(QueryParameter instance1, QueryParameter instance2)
		{
			if (instance1 == null)
			{
