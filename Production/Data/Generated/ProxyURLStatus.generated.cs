...
{
	/// <summary>
	/// Strongly-typed collection for the ProxyURLStatus class.
	/// </summary>
    [Serializable]
	public partial class ProxyURLStatusCollection : ActiveList<ProxyURLStatus, ProxyURLStatusCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLStatusCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(ProxyURLStatus);
		}
	}
	/// <summary>
	/// This is an ActiveRecord class which wraps the ProxyURLStatus table.
	/// </summary>
	[Serializable]
	public partial class ProxyURLStatus : ActiveRecord<ProxyURLStatus>, IActiveRecord, IRecord
	{
		#region Constructors and Default Settings
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected ProxyURLStatus(bool useDatabaseDefaults, bool markNew)
		{
		...
		public ProxyURLStatus() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLStatus(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLStatus(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public ProxyURLStatus(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="ProxyURLStatus"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private ProxyURLStatus(ProxyURLStatus original)
			: this(false, false)
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(ProxyURLStatus original)
		{
		...
		/// <param name="original">The <see cref="ProxyURLStatus"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static ProxyURLStatus Copy(ProxyURLStatus original)
		{
			return new ProxyURLStatus(original);
		}
		#endregion
		#endregion
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ProxyURLStatus", TableType.Table, DataService.GetInstance("ElementsCPSDB"));
				...
				colvarRowStatusId.ForeignKeyTableName = "";
				...
				DataService.Providers["ElementsCPSDB"].AddSchema("ProxyURLStatus",schema);
			}
		}
		#endregion
		...
		{
			return new HP.ElementsCPS.Data.SubSonicClient.ProxyURLCollection().Where(ProxyURL.Columns.ProxyURLStatusId, Id).Load();
		}
		#endregion
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="ProxyURLStatus"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("ProxyURLStatus#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="ProxyURLStatus"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="ProxyURLStatus"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="ProxyURLStatus"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			ProxyURLStatus instance1 = this;
			ProxyURLStatus instance2 = obj as ProxyURLStatus;
			bool isEqual =
				(instance2 != null)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="ProxyURLStatus"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="ProxyURLStatus"/> to compare.</param>
		/// <param name="instance2">The second <see cref="ProxyURLStatus"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(ProxyURLStatus instance1, ProxyURLStatus instance2)
		{
			if (instance1 == null)
			{
