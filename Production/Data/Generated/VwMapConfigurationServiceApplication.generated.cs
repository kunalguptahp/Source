...
namespace HP.ElementsCPS.Data.SubSonicClient{
	/// <summary>
	/// Strongly-typed collection for the VwMapConfigurationServiceApplication class.
	/// </summary>
	[Serializable]
	public partial class VwMapConfigurationServiceApplicationCollection : ReadOnlyList<VwMapConfigurationServiceApplication, VwMapConfigurationServiceApplicationCollection>, IRecordCollection
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapConfigurationServiceApplicationCollection() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public Type GetRecordType()
		{
			return typeof(VwMapConfigurationServiceApplication);
		}
	}
	/// <summary>
	/// Strongly-typed Controller class for the VwMapConfigurationServiceApplication class.
	/// </summary>
	[Serializable]
	public partial class VwMapConfigurationServiceApplicationController : BaseReadOnlyRecordController<VwMapConfigurationServiceApplication, VwMapConfigurationServiceApplicationCollection, VwMapConfigurationServiceApplicationController>
	{
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapConfigurationServiceApplicationController() {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public override TableSchema.Table GetRecordSchema()
		{
			return VwMapConfigurationServiceApplication.Schema;
		}
	}
	/// <summary>
	/// This is  Read-only wrapper class for the vwMapConfigurationServiceApplication view.
	/// </summary>
	[Serializable]
	public partial class VwMapConfigurationServiceApplication : ReadOnlyRecord<VwMapConfigurationServiceApplication>, IReadOnlyRecord, IRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("vwMapConfigurationServiceApplication", TableType.View, DataService.GetInstance("ElementsCPSDB"));
				...
				TableSchema.TableColumn colvarConfigurationServiceApplicationTypeName = new TableSchema.TableColumn(schema);
				colvarConfigurationServiceApplicationTypeName.ColumnName = "ConfigurationServiceApplicationTypeName";
				colvarConfigurationServiceApplicationTypeName.DataType = DbType.String;
				colvarConfigurationServiceApplicationTypeName.MaxLength = 256;
				colvarConfigurationServiceApplicationTypeName.AutoIncrement = false;
				colvarConfigurationServiceApplicationTypeName.IsNullable = false;
				colvarConfigurationServiceApplicationTypeName.IsPrimaryKey = false;
				colvarConfigurationServiceApplicationTypeName.IsForeignKey = false;
				colvarConfigurationServiceApplicationTypeName.IsReadOnly = false;
				
				schema.Columns.Add(colvarConfigurationServiceApplicationTypeName);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["ElementsCPSDB"].AddSchema("vwMapConfigurationServiceApplication",schema);
			}
		}
		#endregion
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		protected VwMapConfigurationServiceApplication(bool useDatabaseDefaults, bool markNew)
		{
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapConfigurationServiceApplication() : this(false) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapConfigurationServiceApplication(bool useDatabaseDefaults) : this(useDatabaseDefaults, true) {}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapConfigurationServiceApplication(object keyID)
			: this(false, false)
		{
			LoadByKey(keyID);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public VwMapConfigurationServiceApplication(string columnName, object columnValue)
			: this(false, false)
		{
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="original">The <see cref="VwMapConfigurationServiceApplication"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private VwMapConfigurationServiceApplication(VwMapConfigurationServiceApplication original)
			: this()
		{
			this.CopyConstuctorHelper(original);
		}
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		private void CopyConstuctorHelper(VwMapConfigurationServiceApplication original)
		{
			...
			this.ConfigurationServiceApplicationTypeName = original.ConfigurationServiceApplicationTypeName;
		...
		/// <param name="original">The <see cref="VwMapConfigurationServiceApplication"/> instance to duplicate.</param>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static VwMapConfigurationServiceApplication Copy(VwMapConfigurationServiceApplication original)
		{
			return new VwMapConfigurationServiceApplication(original);
		}
		#endregion
		#endregion
		#region Properties
		...
		partial void OnConfigurationServiceApplicationTypeNameChanging(string newValue);
		partial void OnConfigurationServiceApplicationTypeNameChanged(string oldValue, string newValue);
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		[XmlAttribute("ConfigurationServiceApplicationTypeName")]
		[Bindable(true)]
		public string ConfigurationServiceApplicationTypeName 
		{
			get
			{
				return GetColumnValue<string>("ConfigurationServiceApplicationTypeName");
			}
			set
			{
				this.OnConfigurationServiceApplicationTypeNameChanging(value);
				this.OnPropertyChanging("ConfigurationServiceApplicationTypeName", value);
				string oldValue = this.ConfigurationServiceApplicationTypeName;
				SetColumnValue("ConfigurationServiceApplicationTypeName", value);
				this.OnConfigurationServiceApplicationTypeNameChanged(oldValue, value);
				this.OnPropertyChanged("ConfigurationServiceApplicationTypeName", oldValue, value);
			}
		}
		#endregion
		...
		public struct Columns
		{
			...
			public static string ConfigurationServiceApplicationTypeName = @"ConfigurationServiceApplicationTypeName";
		...
		// /// </summary>
		// /// <returns>A hash code for the current <see cref="VwMapConfigurationServiceApplication"/>.</returns>
		// [System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		// public override int GetHashCode()
		// {
		// 	//return base.GetHashCode();
		// 	//return this.GetPrimaryKeyValue().GetHashCode();
		// 	return string.Format("VwMapConfigurationServiceApplication#{0}", this.GetPrimaryKeyValue()).GetHashCode();
		// }
		/// <summary>
		/// Determines whether the specified <see cref="Object"/> is identical to the current <see cref="VwMapConfigurationServiceApplication"/>.
		/// </summary>
		/// <param name="obj">The <see cref="Object"/> to compare with the current <see cref="VwMapConfigurationServiceApplication"/>. </param>
		/// <returns><c>true</c> if the specified <see cref="Object"/> is identical to the current <see cref="VwMapConfigurationServiceApplication"/>; otherwise, <c>false</c>.</returns>
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public bool IdenticalTo(object obj)
		{
			VwMapConfigurationServiceApplication instance1 = this;
			VwMapConfigurationServiceApplication instance2 = obj as VwMapConfigurationServiceApplication;
			bool isEqual =
				(instance2 != null)
				...
				&& (instance1.ConfigurationServiceApplicationTypeName == instance2.ConfigurationServiceApplicationTypeName)
...
/*
		/// <summary>
		/// Determines whether the specified <see cref="VwMapConfigurationServiceApplication"/> instances are considered equal.
		/// </summary>
		/// <param name="instance1">The first <see cref="VwMapConfigurationServiceApplication"/> to compare.</param>
		/// <param name="instance2">The second <see cref="VwMapConfigurationServiceApplication"/> to compare.</param>
		/// <returns>
		...
		[System.CodeDom.Compiler.GeneratedCodeAttribute("SubSonic", "2.1.0.0")]
		public static bool Equals(VwMapConfigurationServiceApplication instance1, VwMapConfigurationServiceApplication instance2)
		{
			if (instance1 == null)
			{
