...
namespace HP.ElementsCPS.Data.SubSonicClient
{
	...
	/// </summary>
	public partial class VwMapWorkflowTypeController
	{

		#region ObjectDataSource Methods

		[DataObjectMethod(DataObjectMethodType.Select, true)]
        public static VwMapWorkflowTypeCollection ODSFetch(string tenantGroupId, string serializedQuerySpecificationXml, int maximumRows, int startRowIndex, string sortExpression)
		{
		...
		public static VwMapWorkflowTypeCollection Fetch(WorkflowTypeQuerySpecification qs)
		{
			return CreateQuery(qs, false).ExecuteAsCollection<VwMapWorkflowTypeCollection>();
		}
        public static DataTable FetchToDataTable(WorkflowTypeQuerySpecification qs)
        {
...
#warning Not Implemented: Validate that all of the Query conditions specified by the QuerySpecification are supported by this method.
			return WorkflowTypeController.CreateQueryHelper(qs, VwMapWorkflowType.Schema, isCountQuery);
		}
