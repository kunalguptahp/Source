...
namespace HP.ElementsCPS.Data.SubSonicClient
{
	...
	/// </summary>
	public partial class VwMapPersonRoleController
	{
		#region Constants
		...
		private static readonly string[] _ValidQueryConditionKeys = new[]
			{
				...
				PersonQuerySpecification.Key_RoleId,
		...
		public static VwMapPersonRoleCollection ODSFetch(string serializedQuerySpecificationXml, int maximumRows, int startRowIndex, string sortExpression)
		{
		...
		public static VwMapPersonRoleCollection Fetch(PersonQuerySpecification qs)
		{
			return CreateQuery(qs, false).ExecuteAsCollection<VwMapPersonRoleCollection>();
		}
...
#warning Not Implemented: Re-enable QuerySpecification validation (after it has been code reviewed and tested)
			...
			return PersonController.CreateQueryHelper(qs, VwMapPersonRole.Schema, isCountQuery);
		}
