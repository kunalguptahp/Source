...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class ConfigurationServiceGroupSelectorQuerySpecification : GenericQuerySpecificationWrapper
    {
        ...
        public ConfigurationServiceGroupSelectorQuerySpecification()
            : base()
        {
        }

        public ConfigurationServiceGroupSelectorQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

        public ConfigurationServiceGroupSelectorQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
