...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class WorkflowModuleCategoryQuerySpecification : GenericQuerySpecificationWrapper
    {
        #region Constants
        ...
        public WorkflowModuleCategoryQuerySpecification()
            : base()
        {
        }

        public WorkflowModuleCategoryQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

		public WorkflowModuleCategoryQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
