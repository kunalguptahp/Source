...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class JumpstationApplicationQuerySpecification : GenericQuerySpecificationWrapper
    {
        #region Constants
        ...
        public JumpstationApplicationQuerySpecification()
            : base()
        {
        }

        public JumpstationApplicationQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

		public JumpstationApplicationQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
