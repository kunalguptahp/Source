...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class JumpstationGroupTypeQuerySpecification : GenericQuerySpecificationWrapper
    {
        ...
        public JumpstationGroupTypeQuerySpecification()
            : base()
        {
        }

        public JumpstationGroupTypeQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

		public JumpstationGroupTypeQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
