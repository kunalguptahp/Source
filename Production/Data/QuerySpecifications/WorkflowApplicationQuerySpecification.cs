...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class WorkflowApplicationQuerySpecification : GenericQuerySpecificationWrapper
    {
        #region Constants
        ...
        public WorkflowApplicationQuerySpecification()
            : base()
        {
        }

        public WorkflowApplicationQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

		public WorkflowApplicationQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
