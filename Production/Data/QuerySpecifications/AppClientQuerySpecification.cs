...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class AppClientQuerySpecification : GenericQuerySpecificationWrapper
    {
        ...
        public AppClientQuerySpecification()
            : base()
        {
        }

        public AppClientQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

        public AppClientQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
