...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class ConfigurationServiceLabelValueImportQuerySpecification : GenericQuerySpecificationWrapper
    {
        ...
        public ConfigurationServiceLabelValueImportQuerySpecification()
            : base()
        {
        }

        public ConfigurationServiceLabelValueImportQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

        public ConfigurationServiceLabelValueImportQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
