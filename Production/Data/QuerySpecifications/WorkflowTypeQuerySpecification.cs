...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class WorkflowTypeQuerySpecification : GenericQuerySpecificationWrapper
    {
        ...
        public WorkflowTypeQuerySpecification()
            : base()
        {
        }

        public WorkflowTypeQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

		public WorkflowTypeQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
