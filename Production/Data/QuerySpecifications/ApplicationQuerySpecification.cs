...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class ApplicationQuerySpecification : GenericQuerySpecificationWrapper
    {
        ...
        public ApplicationQuerySpecification()
            : base()
        {
        }

        public ApplicationQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

        public ApplicationQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
