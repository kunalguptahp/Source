...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class ProxyURLGroupTypeQuerySpecification : GenericQuerySpecificationWrapper
    {
        ...
        public ProxyURLGroupTypeQuerySpecification()
            : base()
        {
        }

        public ProxyURLGroupTypeQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

        public ProxyURLGroupTypeQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
