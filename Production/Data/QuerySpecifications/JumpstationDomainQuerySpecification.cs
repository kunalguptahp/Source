...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class JumpstationDomainQuerySpecification : GenericQuerySpecificationWrapper
    {
        ...
        public JumpstationDomainQuerySpecification()
            : base()
        {
        }

        public JumpstationDomainQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

		public JumpstationDomainQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
