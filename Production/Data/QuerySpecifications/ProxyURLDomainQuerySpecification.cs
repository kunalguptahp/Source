...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class ProxyURLDomainQuerySpecification : GenericQuerySpecificationWrapper
    {
        ...
        public ProxyURLDomainQuerySpecification()
            : base()
        {
        }

        public ProxyURLDomainQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

        public ProxyURLDomainQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
