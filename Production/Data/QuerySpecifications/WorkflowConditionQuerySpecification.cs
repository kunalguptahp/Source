...
namespace HP.ElementsCPS.Data.QuerySpecifications
{
    ...
    public class WorkflowConditionQuerySpecification : GenericQuerySpecificationWrapper
    {
        #region Constants
        ...
        public WorkflowConditionQuerySpecification()
            : base()
        {
        }

        public WorkflowConditionQuerySpecification(QuerySpecification innerQuery)
            : base(innerQuery)
        {
        }

		public WorkflowConditionQuerySpecification(IQuerySpecification original)
            : base(original)
        {
        }
