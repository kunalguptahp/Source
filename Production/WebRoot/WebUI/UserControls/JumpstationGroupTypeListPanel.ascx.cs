...
{
	public partial class JumpstationGroupTypeListPanel : BaseListViewUserControl
	{
		...
		{
			JumpstationGroupTypeQuerySpecification query = this.ConvertToExpectedType(querySpecification);
			JumpstationGroupTypeQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
		...
		{
			JumpstationGroupTypeQuerySpecification query = new JumpstationGroupTypeQuerySpecification();
			GridView gv = this.Grid;
		...
		protected override void ExportData(IQuerySpecification querySpecification, string exportFormat, string filename)
		{
			...
			this.ExportData(query, exportFormat, filename, Global.YieldDataTablesForDataExport<VwMapJumpstationGroupType, VwMapJumpstationGroupTypeCollection, JumpstationGroupTypeQuerySpecification>(query, VwMapJumpstationGroupTypeController.Fetch));
		}
		...
		/// </summary>
		public JumpstationGroupTypeQuerySpecification ConvertedQuerySpecification
		{
			get
			{
		...
		{
			this.Response.Redirect(Global.GetJumpstationGroupTypeUpdatePageUri(groupTypeId, this.QuerySpecification));
		}
