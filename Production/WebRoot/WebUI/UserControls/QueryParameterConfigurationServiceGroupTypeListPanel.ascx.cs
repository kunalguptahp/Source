...
{
    public partial class QueryParameterConfigurationServiceGroupTypeListPanel : BaseListViewUserControl
	{
		...
		{
            QueryParameterConfigurationServiceGroupTypeQuerySpecification query = this.ConvertToExpectedType(querySpecification);
            QueryParameterConfigurationServiceGroupTypeQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
		...
		{
            QueryParameterConfigurationServiceGroupTypeQuerySpecification query = new QueryParameterConfigurationServiceGroupTypeQuerySpecification();
			GridView gv = this.Grid;
		...
		{
            this.EditQueryParameterConfigurationServiceGroupType(this.GetRowIdInt32(index));
		}

		protected override void PopulateListControls()
        {
            int tenantId = PersonController.GetCurrentUser().TenantGroupId;
            Global.BindConfigurationServiceGroupTypeListControl(this.ddlConfigurationServiceGroupType, RowStatus.RowStatusId.Active,tenantId,true);
		...
		protected override void ExportData(IQuerySpecification querySpecification, string exportFormat, string filename)
		{
            ...
            this.ExportData(query, exportFormat, filename, Global.YieldDataTablesForDataExport<VwMapQueryParameterConfigurationServiceGroupType, VwMapQueryParameterConfigurationServiceGroupTypeCollection, QueryParameterConfigurationServiceGroupTypeQuerySpecification>(query, VwMapQueryParameterConfigurationServiceGroupTypeController.Fetch));
		}
		...
		/// </summary>
        public QueryParameterConfigurationServiceGroupTypeQuerySpecification ConvertedQuerySpecification
		{
			get
			{
		...
		{
            this.EditQueryParameterConfigurationServiceGroupType(null);
		}
        ...
        private void EditQueryParameterConfigurationServiceGroupType(int? queryParameterConfigurationServiceGroupTypeId)
		{
            this.Response.Redirect(Global.GetQueryParameterConfigurationServiceGroupTypeUpdatePageUri(queryParameterConfigurationServiceGroupTypeId, this.QuerySpecification));
		}
