...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProxyURLMultiReplaceUpdatePanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.ProxyURLMultiReplaceUpdatePanel" %>
<%@ Register Src="~/UserControls/ProxyURLDescriptionMultiReplaceUpdatePanel.ascx" TagName="ProxyURLDescriptionMultiReplaceUpdatePanel"
	...
	<table border="1">
		<tr>
			...
			<td>
				<asp:Panel ID="pnlQueryParameterValueMultiUpdatePanel" runat="server">
					<ElementsCPSuc:ProxyURLDescriptionMultiReplaceUpdatePanel ID="ucProxyURLDescriptionMultiReplaceUpdate" runat="server" />
				</asp:Panel>
            </td>
		</tr>
		<tr>
			...
			<td>
				<asp:Panel ID="pnlDataControls_TagsToAdd" runat="server">
					...
					<hpfx:CustomValidator ID="cvTxtTagsToAddMaxTagCount" runat="server" ControlToValidate="txtTagsToAdd"
						Enabled="false"
						ValidationGroup="SaveProxyURL" 
						ErrorMessage="Too many Tags. There is a limit of 100 Tags per Offer (ex. tag_01, tag_02)." 
		...
		<tr>
			<td align="center" colspan="2" >
                <asp:Button ID="btnEditRedirectors" Text="Edit Redirectors..." runat="server" ToolTip="Edit Redirector Replacements "
                    OnClick="btnEditRedirectors_Click" Enabled="false" />
