...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkflowApplicationListPanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.WorkflowApplicationListPanel" %>
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id"
							DataNavigateUrlFormatString="~/DataAdmin/WorkflowApplicationUpdate.aspx?id={0}" />
						<asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
						<asp:BoundField DataField="Version" HeaderText="Version" SortExpression="Version" />
						<asp:BoundField DataField="ElementsKey" HeaderText="ElementsKey" SortExpression="ElementsKey" />
						<asp:BoundField DataField="WorkflowApplicationTypeName" HeaderText="Application Type" SortExpression="WorkflowApplicationTypeName" />
...
<asp:ObjectDataSource ID="odsDataSource" runat="server" EnablePaging="true"
	SelectMethod="ODSFetch" SelectCountMethod="ODSFetchCount" TypeName="HP.ElementsCPS.Data.SubSonicClient.VwMapWorkflowApplicationController"
