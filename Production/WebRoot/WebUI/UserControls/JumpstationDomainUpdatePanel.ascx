...
<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="JumpstationDomainUpdatePanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.JumpstationDomainUpdatePanel" %>
<asp:Panel ID="pnlEditArea" runat="server" DefaultButton="btnSave">
	<table border="1">
		...
		<tr>
			<td>
				<asp:Label ID="lblDomainURL" runat="server" Text="Domain URL: *" SkinID="DataFieldLabel" AssociatedControlID="txtDomainURL"></asp:Label>
			</td>
			<td>
				<asp:TextBox ID="txtDomainURL" runat="server" MaxLength="256" Columns="100"></asp:TextBox>				
				<HPFx:RequiredFieldValidator ID="rfvDomainURL" runat="server" ControlToValidate="txtDomainURL"
					ErrorMessage="Please enter a domain url.<br/>" />
			</td>
		</tr>
		<tr>
			<td>
