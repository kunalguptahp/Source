...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QueryParameterWorkflowTypeListPanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.QueryParameterWorkflowTypeListPanel" %>
<asp:Panel ID="pnlList" runat="server">
	<table border="0">
		...
		<tr>
			<td align="left" colspan="2">
				<asp:Button ID="btnCreate" SkinID="CreateItem..." runat="server" ToolTip="Create new Parameter/Workflow Type"
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id"
							DataNavigateUrlFormatString="~/DataAdmin/QueryParameterWorkflowTypeUpdate.aspx?id={0}" />
						<asp:BoundField DataField="QueryParameterWorkflowTypeName" HeaderText="Name" SortExpression="QueryParameterWorkflowTypeName" />
						<asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
						<asp:BoundField DataField="Name" HeaderText="Workflow Type" SortExpression="Name" />
					...
					<EmptyDataTemplate>
						<asp:Label ID="lblEmptyData" runat="server" Text="Label">There are no parameter/workflow type(s) found</asp:Label>
					</EmptyDataTemplate>
...
<asp:ObjectDataSource ID="odsDataSource" runat="server" EnablePaging="true"
	SelectMethod="ODSFetch" SelectCountMethod="ODSFetchCount" TypeName="HP.ElementsCPS.Data.SubSonicClient.VwMapQueryParameterWorkflowTypeController"
