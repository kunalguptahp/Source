...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationServiceQueryParameterValueImportListPanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.ConfigurationServiceQueryParameterValueImportListPanel" %>
<asp:Panel ID="pnlList" runat="server">
	<table border="0">
		...
		<tr>
			<td align="left" colspan="2">
				<asp:Button ID="btnCreate" SkinID="CreateItem..." runat="server" ToolTip="Create new Query Parameter Value"
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id"
							DataNavigateUrlFormatString="~/ConfigurationService/ConfigurationServiceQueryParameterValueImportUpdate.aspx?id={0}" />
						<asp:BoundField DataField="QueryParameterName" HeaderText="Parameter Name" SortExpression="QueryParameterName" />
						<asp:BoundField DataField="QueryParameterValue" HeaderText="Parameter Value" SortExpression="QueryParameterValue" />
...
--%>						<asp:CommandField Visible="false" ShowHeader="false" ButtonType="Button" CausesValidation="false" />
					...
					<EmptyDataTemplate>
						<asp:Label ID="lblEmptyData" runat="server" Text="Label">There are no query parameter values found</asp:Label>
					</EmptyDataTemplate>
...
<asp:ObjectDataSource ID="odsDataSource" runat="server" EnablePaging="true" SelectMethod="ODSFetch"
	SelectCountMethod="ODSFetchCount" TypeName="HP.ElementsCPS.Data.SubSonicClient.VwMapConfigurationServiceQueryParameterValueImportController"
