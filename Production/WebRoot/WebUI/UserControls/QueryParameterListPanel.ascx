...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QueryParameterListPanel.ascx.cs"
    Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.QueryParameterListPanel" %>
<asp:Panel ID="pnlList" runat="server">
	<table border="0">
		...
		<tr>
			<td align="left" colspan="2">
				<asp:Button ID="btnCreate" SkinID="CreateItem..." runat="server" ToolTip="Create new Parameter"
                                    ...
                                    <table border="1">
                                        <tr>
                                            ...
                                            <td align="left">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblProxyURLType" runat="server" SkinID="FilterLabel" AssociatedControlID="ddlProxyURLType"
                                                                Text="Redirector Type:"></asp:Label>
                                                            <asp:DropDownList ID="ddlProxyURLType" SkinID="ForeignKeyColumnFilter" runat="server"
                                                                ToolTip="Filter redirector type">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblConfigurationServiceGroupType" runat="server" SkinID="FilterLabel"
                                                                AssociatedControlID="ddlProxyURLType" Text="Configuration Service Group Type:"></asp:Label>
                                                            <asp:DropDownList ID="ddlConfigurationServiceGroupType" SkinID="ForeignKeyColumnFilter"
                                                                runat="server" ToolTip="Filter group type">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblWorkflowType" runat="server" SkinID="FilterLabel" AssociatedControlID="ddlWorkflowType"
                                                                Text="Workflow Type:"></asp:Label>
                                                            <asp:DropDownList ID="ddlWorkflowType" SkinID="ForeignKeyColumnFilter" runat="server"
                                                                ToolTip="Filter workflow type">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            <td align="left">
                                                ...
                                                <asp:TextBox ID="txtName" SkinID="NameFilter" runat="server"></asp:TextBox>
                                            </td>
                                            <td align="left">
                                                <asp:Label ID="lblStatus" runat="server" SkinID="FilterLabel" AssociatedControlID="ddlStatus"
            ...
            <td colspan="2">
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/DataAdmin/QueryParameterUpdate.aspx?id={0}" />
						<asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
						<asp:BoundField DataField="ElementsKey" HeaderText="ElementsKey" SortExpression="ElementsKey" />
					...
					<EmptyDataTemplate>
						<asp:Label ID="lblEmptyData" runat="server" Text="Label">There are no parameters found</asp:Label>
					</EmptyDataTemplate>
...
<asp:ObjectDataSource ID="odsDataSource" runat="server" EnablePaging="true"
    SelectMethod="ODSFetch" SelectCountMethod="ODSFetchCount" TypeName="HP.ElementsCPS.Data.SubSonicClient.VwMapQueryParameterController"
