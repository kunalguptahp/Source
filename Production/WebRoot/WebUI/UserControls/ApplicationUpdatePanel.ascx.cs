...
{
    public partial class ApplicationUpdatePanel : RecordDetailUserControl
    {
        #region Properties
        ...
        {
            ApplicationQuerySpecification defaultValuesSpecification = this.ConvertToExpectedType(this.DefaultValuesSpecification);
        ...
        protected override void BindItem()
        {
            ...
            else
            {
                try
                {
                    Application bindItem = HP.ElementsCPS.Data.SubSonicClient.Application.FetchByID(this.DataSourceId);
                    if (bindItem == null)
                    {
                        this.Visible = false;
                        return;
        ...
        protected override void SaveInput()
        {
            ...
            {
                saveItem = HP.ElementsCPS.Data.SubSonicClient.Application.FetchByID(this.DataSourceId);
            }
            else
            {
                saveItem = new Application(true);
            }
            ...
            Global.RemoveApplicationListControl(RowStatus.RowStatusId.Active);
        }
