...
{
	public class ConfigurationServiceGroupMultiReplaceTemplate : ITemplate
	{
		...
		public ConfigurationServiceGroupMultiReplaceTemplate(DataControlRowType type, string colname, int id)
		{
			_templateType = type;
			_columnName = colname;
			this._id = id;
