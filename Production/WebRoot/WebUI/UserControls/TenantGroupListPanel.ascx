...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TenantGroupListPanel.ascx.cs" Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.TenantGroupListPanel" %>
...
<asp:Panel ID="pnlList" runat="server">
	<table border="0">
		...
		<tr>
			<td align="left" colspan="2">
				<asp:Button ID="btnCreate" SkinID="CreateItem..." runat="server" ToolTip="Create new TenantGroup"
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id"
							DataNavigateUrlFormatString="~/DataAdmin/TenantGroupUpdate.aspx?id={0}" />
...
<asp:ObjectDataSource ID="odsDataSource" runat="server" EnablePaging="true"
    SelectMethod="ODSFetch" SelectCountMethod="ODSFetchCount" TypeName="HP.ElementsCPS.Data.SubSonicClient.VwMapTenantController"
