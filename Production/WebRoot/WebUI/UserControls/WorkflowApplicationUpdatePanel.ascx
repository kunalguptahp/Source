...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkflowApplicationUpdatePanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.WorkflowApplicationUpdatePanel" %>
