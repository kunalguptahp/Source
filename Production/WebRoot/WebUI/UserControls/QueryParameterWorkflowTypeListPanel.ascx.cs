...
{
	public partial class QueryParameterWorkflowTypeListPanel : BaseListViewUserControl
	{
		...
		{
			QueryParameterWorkflowTypeQuerySpecification query = this.ConvertToExpectedType(querySpecification);
			QueryParameterWorkflowTypeQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
		...
		{
			QueryParameterWorkflowTypeQuerySpecification query = new QueryParameterWorkflowTypeQuerySpecification();
			GridView gv = this.Grid;
		...
		{
			this.EditQueryParameterWorkflowType(this.GetRowIdInt32(index));
		}
		...
		protected override void ExportData(IQuerySpecification querySpecification, string exportFormat, string filename)
		{
			...
			this.ExportData(query, exportFormat, filename, Global.YieldDataTablesForDataExport<VwMapQueryParameterWorkflowType, VwMapQueryParameterWorkflowTypeCollection, QueryParameterWorkflowTypeQuerySpecification>(query, VwMapQueryParameterWorkflowTypeController.Fetch));
		}
		...
		/// </summary>
		public QueryParameterWorkflowTypeQuerySpecification ConvertedQuerySpecification
		{
			get
			{
		...
		{
			this.EditQueryParameterWorkflowType(null);
		}
		...
		private void EditQueryParameterWorkflowType(int? queryParameterWorkflowTypeId)
		{
			this.Response.Redirect(Global.GetQueryParameterWorkflowTypeUpdatePageUri(queryParameterWorkflowTypeId, this.QuerySpecification));
		}
