...
{
    public partial class TenantGroupListPanel : BaseListViewUserControl
    {
        #region Overrides
        ...
        {
            TenantQuerySpecification query = this.ConvertToExpectedType(querySpecification);
            TenantQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
        ...
        {
            TenantQuerySpecification query = new TenantQuerySpecification();
            GridView gv = this.Grid;
        ...
        {
            this.EditTenantGroup(this.GetRowIdInt32(index));
        }
        ...
        protected override void ExportData(IQuerySpecification querySpecification, string exportFormat, string filename)
        {
            ...
            this.ExportData(querySpecification, exportFormat, filename, Global.YieldDataTablesForDataExport<VwMapTenant, VwMapTenantCollection, TenantQuerySpecification>(querySpecification, VwMapTenantController.Fetch));
        }
        ...
        /// </summary>
        public TenantQuerySpecification ConvertedQuerySpecification
        {
            get
            {
        ...
        private void EditTenantGroup(int? id)
        {
            this.Response.Redirect(Global.GetTenantGroupUpdatePageUri(id, this.QuerySpecification));
        }
