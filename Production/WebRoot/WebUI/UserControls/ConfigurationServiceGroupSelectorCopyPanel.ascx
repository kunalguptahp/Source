...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationServiceGroupSelectorCopyPanel.ascx.cs"
    Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.ConfigurationServiceGroupSelectorCopyPanel" %>
        ...
        <tr>
            <td colspan="2">
                <asp:ValidationSummary ID="vsDefaultValidationSummary" runat="server" HeaderText="Invalid Input:"
                    ValidationGroup="saveConfigurationServiceGroupSelector" />
