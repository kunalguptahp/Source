...
{
    public partial class AppClientListPanel  : BaseListViewUserControl
    {
        #region Overrides
        ...
        {
            AppClientQuerySpecification query = this.ConvertToExpectedType(querySpecification);
            AppClientQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
        ...
        {
            AppClientQuerySpecification query = new AppClientQuerySpecification();
            GridView gv = this.Grid;
        ...
        {
            this.EditAppClient(this.GetRowIdInt32(index));
        }
        ...
        protected override void ExportData(IQuerySpecification querySpecification, string exportFormat, string filename)
        {
            ...
            this.ExportData(querySpecification, exportFormat, filename, Global.YieldDataTablesForDataExport<VwMapAppClient, VwMapAppClientCollection, AppClientQuerySpecification>(querySpecification, VwMapAppClientController.Fetch));
        }
        ...
        /// </summary>
        public AppClientQuerySpecification ConvertedQuerySpecification
        {
            get
            {
        ...
        private void EditAppClient(int? id)
        {
            this.Response.Redirect(Global.GetAppClientUpdatePageUri(id, this.QuerySpecification));
        }
        ...
        /// <returns></returns>
        public AppClientQuerySpecification ConvertToExpectedType(IQuerySpecification original)
        {
            if (original == null)
            {
                return null;
            ...
            return original as AppClientQuerySpecification ?? new AppClientQuerySpecification(original);
        }
