...
{
	public partial class WorkflowModuleSubCategoryUpdatePanel : RecordDetailUserControl
	{
		#region Properties
...
//				this.UpdateChildListImmutableConditions();
		...
		{
			WorkflowModuleSubCategoryQuerySpecification defaultValuesSpecification = this.ConvertToExpectedType(this.DefaultValuesSpecification);
		...
		protected override void BindItem()
		{
			...
			else
			{
				try
				{
					WorkflowModuleSubCategory bindItem = WorkflowModuleSubCategory.FetchByID(this.DataSourceId);
					if (bindItem == null)
					{
						this.Visible = false;
						return;
		...
		{
			WorkflowModuleSubCategory saveItem;
			if (this.DataSourceId != null)
			{
				saveItem = WorkflowModuleSubCategory.FetchByID(this.DataSourceId);
			}
			else
			{
				saveItem = new WorkflowModuleSubCategory(true);
			}
            ...
            Global.RemoveWorkflowModuleSubCategoryListControl(RowStatus.RowStatusId.Active);
		}
