...
{
	public class JumpstationGroupMultiReplaceTemplate : ITemplate
	{
		public const string ID = "ID";
        public const string TARGET_URL = "TargetUrl";
        public const string DESCRIPTION = "Description";
        public const string REDIRECTOR_TYPE = "Jumpstation Type";
		...
		public JumpstationGroupMultiReplaceTemplate(DataControlRowType type, string colname, int id)
		{
			_templateType = type;
			_columnName = colname;
			this._id = id;
