...
{
	public partial class ProxyURLGroupTypeListPanel : BaseListViewUserControl
	{
		...
		{
			ProxyURLGroupTypeQuerySpecification query = this.ConvertToExpectedType(querySpecification);
			ProxyURLGroupTypeQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
		...
		{
			ProxyURLGroupTypeQuerySpecification query = new ProxyURLGroupTypeQuerySpecification();
			GridView gv = this.Grid;
		...
		protected override void ExportData(IQuerySpecification querySpecification, string exportFormat, string filename)
		{
			...
			this.ExportData(querySpecification, exportFormat, filename, Global.YieldDataTablesForDataExport<VwMapProxyURLGroupType, VwMapProxyURLGroupTypeCollection, ProxyURLGroupTypeQuerySpecification>(querySpecification, VwMapProxyURLGroupTypeController.Fetch));
		}
		...
		/// </summary>
		public ProxyURLGroupTypeQuerySpecification ConvertedQuerySpecification
		{
			get
			{
		...
		{
			this.Response.Redirect(Global.GetProxyURLGroupTypeUpdatePageUri(groupTypeId, this.QuerySpecification));
		}
		...
		/// <returns></returns>
		public ProxyURLGroupTypeQuerySpecification ConvertToExpectedType(IQuerySpecification original)
		{
			if (original == null)
			{
				return null;
			...
			return original as ProxyURLGroupTypeQuerySpecification ?? new ProxyURLGroupTypeQuerySpecification(original);
		}
