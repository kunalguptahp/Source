...
{
	public partial class JumpstationApplicationUpdatePanel : RecordDetailUserControl
	{
...
//				this.UpdateChildListImmutableConditions();
		...
		{
			JumpstationApplicationQuerySpecification defaultValuesSpecification = this.ConvertToExpectedType(this.DefaultValuesSpecification);
		...
		protected override void BindItem()
		{
			...
			else
			{
				try
				{
					JumpstationApplication bindItem = JumpstationApplication.FetchByID(this.DataSourceId);
					if (bindItem == null)
					{
						this.Visible = false;
						return;
		...
		{
			JumpstationApplication saveItem;
			if (this.DataSourceId != null)
			{
				saveItem = JumpstationApplication.FetchByID(this.DataSourceId);
			}
			else
			{
				saveItem = new JumpstationApplication(true);
			}
