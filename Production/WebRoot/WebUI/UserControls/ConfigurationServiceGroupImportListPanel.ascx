...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationServiceGroupImportListPanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.ConfigurationServiceGroupImportListPanel" %>
<asp:Panel ID="pnlList" runat="server">
	<table border="0">
		...
		<tr>
			<td align="left" colspan="2">
				<asp:Button ID="btnCreate" SkinID="CreateItem..." runat="server" ToolTip="Create new Configuration Service Group import"
					OnClick="btnCreate_Click" />
				<asp:Button ID="btnExport" SkinID="ExportData" runat="server" OnClick="btnExport_Click" />
                <asp:Button ID="btnEdit" runat="server" Text="Edit (Group Import)..." ToolTip="Edit configuration service group import(s)"
                    OnClick="btnEdit_Click" />
                <asp:Button ID="btnGroupEdit" runat="server" Text="Edit (Group)..." ToolTip="Edit configuration service group(s)"
                    OnClick="btnGroupEdit_Click" />
			</td>
		</tr>
		<tr>
			<td>
									...
									<table border="1">
										...
										<tr>
											...
											<td align="left">
												...
												<asp:TextBox ID="txtDescription" SkinID="NameFilter" runat="server">
												</asp:TextBox>
											</td>
										</tr>
										<tr>
											<td align="left">
												<asp:Label ID="lblApplication" runat="server" SkinID="FilterLabel" AssociatedControlID="ddlApplication" Text="Application:"></asp:Label>
												<asp:DropDownList ID="ddlApplication" SkinID="ForeignKeyColumnFilter" runat="server" ToolTip="Filter application">
												</asp:DropDownList>
											</td>
											<td align="left">
												<asp:Label ID="lblGroupType" runat="server" Text="Group Type:" SkinID="FilterLabel" AssociatedControlID="ddlGroupType"></asp:Label>
												<asp:DropDownList ID="ddlGroupType" SkinID="ForeignKeyColumnFilter" runat="server" ToolTip="Filter group type">
												</asp:DropDownList>
											</td>
										</tr>
										<tr>
											<td align="left">
												<asp:Label ID="lblImportMessage" runat="server" Text="Message:" SkinID="FilterLabel" AssociatedControlID="txtImportMessage"></asp:Label>
												<asp:TextBox ID="txtImportMessage" SkinID="NameFilter" runat="server">
												</asp:TextBox>
											</td>
											<td align="left">
												<asp:Label ID="lblImportStatus" runat="server" Text="Import Status:" SkinID="FilterLabel" AssociatedControlID="txtImportStatus"></asp:Label>
												<asp:TextBox ID="txtImportStatus" SkinID="NameFilter" runat="server">
												</asp:TextBox>
											</td>
										</tr>
										<tr>
											<td align="left">
												<asp:Label ID="lblLabelValue" runat="server" Text="Label Value:" SkinID="FilterLabel" AssociatedControlID="txtLabelValue"></asp:Label>
												<asp:TextBox ID="txtLabelValue" SkinID="NameFilter" runat="server">
												</asp:TextBox>
											</td>
											<td align="left">
		...
		<tr>
			<td colspan="2">
				...
				<hpfx:EnhancedGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True"
					...
					DataKeyNames="Id,ConfigurationServiceGroupId" DataSourceID="odsDataSource">
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id"
							DataNavigateUrlFormatString="~/ConfigurationService/ConfigurationServiceGroupImportUpdate.aspx?id={0}" />
                        ...
                        <asp:TemplateField HeaderText="Group Id"> 
                            <ItemTemplate> 
                                <asp:HyperLink id="hlConfigurationServiceGroupId" runat="server" Target="_blank"  ></asp:HyperLink> 
                            </ItemTemplate> 
                        </asp:TemplateField>
						<asp:BoundField DataField="ImportStatus" HeaderText="Import Status" SortExpression="ImportStatus" />
						<asp:BoundField DataField="ImportMessage" HeaderText="Message" SortExpression="ImportMessage" />
						<asp:BoundField DataField="LabelValue" HeaderText="Label Values" SortExpression="LabelValue" />
					...
					<EmptyDataTemplate>
						<asp:Label ID="lblEmptyData" runat="server" Text="Label">There are no group to import found</asp:Label>
					</EmptyDataTemplate>
...
<asp:ObjectDataSource ID="odsDataSource" runat="server" EnablePaging="true"
	SelectMethod="ODSFetch" SelectCountMethod="ODSFetchCount" TypeName="HP.ElementsCPS.Data.SubSonicClient.VwMapConfigurationServiceGroupImportController"
