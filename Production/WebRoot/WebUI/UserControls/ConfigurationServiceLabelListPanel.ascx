...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationServiceLabelListPanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.ConfigurationServiceLabelListPanel" %>
<asp:Panel ID="pnlList" runat="server">
	<table border="0">
		...
		<tr>
			<td align="left" colspan="2">
				<asp:Button ID="btnCreate" SkinID="CreateItem..." runat="server" ToolTip="Create new Label"
							...
							<td>
								<asp:Panel ID="pnlFilterArea" runat="server" DefaultButton="btnFilter">
									<table border="1">
										<tr>
											<td align="left">
												<asp:Label ID="lblIdList" runat="server" SkinID="FilterLabel" AssociatedControlID="txtIdList" Text="Label IDs:"></asp:Label>
											...
											<td align="left">
												<asp:Label ID="lblItem" runat="server" SkinID="FilterLabel" AssociatedControlID="ddlItem" Text="Item:"></asp:Label>
												<asp:DropDownList ID="ddlItem" SkinID="ForeignKeyColumnFilter" runat="server" ToolTip="Filter Item ">
												</asp:DropDownList>
											</td>
										</tr>
										<tr>
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id"
							DataNavigateUrlFormatString="~/DataAdmin/ConfigurationServiceLabelUpdate.aspx?id={0}" />
						<asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
						<asp:BoundField DataField="ElementsKey" HeaderText="ElementsKey" SortExpression="ElementsKey" />
						<asp:HyperLinkField HeaderText="Item" SortExpression="ConfigurationServiceItemName"
							DataTextField="ConfigurationServiceItemName" DataNavigateUrlFields="ConfigurationServiceItemId"
							DataNavigateUrlFormatString="~/DataAdmin/ConfigurationServiceItemUpdate.aspx?id={0}" />
					...
					<EmptyDataTemplate>
						<asp:Label ID="lblEmptyData" runat="server" Text="Label">There are no Labels found</asp:Label>
					</EmptyDataTemplate>
...
<asp:ObjectDataSource ID="odsDataSource" runat="server" EnablePaging="true"
	SelectMethod="ODSFetch" SelectCountMethod="ODSFetchCount" TypeName="HP.ElementsCPS.Data.SubSonicClient.VwMapConfigurationServiceLabelController"
