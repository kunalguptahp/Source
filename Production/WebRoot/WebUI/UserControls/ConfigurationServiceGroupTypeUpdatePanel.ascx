...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationServiceGroupTypeUpdatePanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.ConfigurationServiceGroupTypeUpdatePanel" %>
<asp:Panel ID="pnlEditArea" runat="server" DefaultButton="btnSave">
	<table border="1">
		<tr>
			<td>
				<asp:Label ID="lblIdLabel" runat="server" Text="Group Type Id:" SkinID="DataFieldLabel" AssociatedControlID="lblIdValue"></asp:Label>
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<asp:DropDownList ID="ddlConfigurationServiceApplication" runat="server">
				</asp:DropDownList>
				<HPFx:RequiredFieldValidator ID="rfvConfigurationServiceApplication" runat="server" ControlToValidate="ddlConfigurationServiceApplication"
