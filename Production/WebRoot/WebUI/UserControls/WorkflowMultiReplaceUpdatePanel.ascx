...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkflowMultiReplaceUpdatePanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.WorkflowMultiReplaceUpdatePanel" %>
<%@ Register Src="~/UserControls/WorkflowDescriptionMultiReplaceUpdatePanel.ascx" TagName="WorkflowDescriptionMultiReplaceUpdatePanel"
...
<asp:Panel ID="pnlEditArea" runat="server" DefaultButton="btnSave">
	<table border="1">
		<tr>
			<td>
				<asp:Label ID="lblWorkflows" runat="server" Text="Workflows:" SkinID="DataFieldLabel"></asp:Label>
			</td>
			<td>
				<asp:Panel ID="pnlQueryParameterValueMultiUpdatePanel" runat="server">
					<ElementsCPSuc:WorkflowDescriptionMultiReplaceUpdatePanel ID="ucWorkflowDescriptionMultiReplaceUpdate" runat="server" />
				</asp:Panel>
            </td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center" colspan="2" >
                <asp:Button ID="btnEditWorkflow" Text="Edit Workflows..." runat="server" ToolTip="Edit Workflow Replacements "
                    OnClick="btnEditWorkflow_Click" Enabled="false" />
