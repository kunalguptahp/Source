...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationServiceApplicationTypeUpdatePanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.ConfigurationServiceApplicationTypeUpdatePanel" %>
