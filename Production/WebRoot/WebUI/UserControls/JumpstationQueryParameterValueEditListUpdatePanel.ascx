...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JumpstationQueryParameterValueEditListUpdatePanel.ascx.cs"
    Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.JumpstationQueryParameterValueEditListUpdatePanel" %>
