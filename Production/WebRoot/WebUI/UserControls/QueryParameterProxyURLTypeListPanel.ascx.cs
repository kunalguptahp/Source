...
{
	public partial class QueryParameterProxyURLTypeListPanel : BaseListViewUserControl
	{
		...
		protected override void BindScreen(IQuerySpecification querySpecification)
		{
			...
			QueryParameterProxyURLTypeQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
		...
		{
			this.EditQueryParameterProxyURLType(this.GetRowIdInt32(index));
		}
		...
		protected override void ExportData(IQuerySpecification querySpecification, string exportFormat, string filename)
		{
			...
			this.ExportData(querySpecification, exportFormat, filename, Global.YieldDataTablesForDataExport<VwMapQueryParameterProxyURLType, VwMapQueryParameterProxyURLTypeCollection, QueryParameterProxyURLTypeQuerySpecification>(querySpecification, VwMapQueryParameterProxyURLTypeController.Fetch));
		}
		...
		/// </summary>
		public QueryParameterProxyURLTypeQuerySpecification ConvertedQuerySpecification
		{
			get
			{
		...
		{
			this.EditQueryParameterProxyURLType(null);
		}
		...
		private void EditQueryParameterProxyURLType(int? queryParameterProxyURLTypeId)
		{
			this.Response.Redirect(Global.GetQueryParameterProxyURLTypeUpdatePageUri(queryParameterProxyURLTypeId, this.QuerySpecification));
		}
