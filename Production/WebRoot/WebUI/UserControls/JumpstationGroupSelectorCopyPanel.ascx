...
<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="JumpstationGroupSelectorCopyPanel.ascx.cs"
    Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.JumpstationGroupSelectorCopyPanel" %>
        ...
        <tr>
            <td colspan="2">
                <asp:ValidationSummary ID="vsDefaultValidationSummary" runat="server" HeaderText="Invalid Input:"
                    ValidationGroup="saveJumpstationGroupSelector" />
