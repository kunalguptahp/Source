...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProxyURLDescriptionMultiReplaceUpdatePanel.ascx.cs"
    Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.ProxyURLDescriptionMultiReplaceUpdatePanel" %>
        ...
        <tr>
            <td>
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="False"
                    ...
                    <EmptyDataTemplate>
                        <asp:Label ID="lblEmptyData" runat="server" Text="Label">Please select Redirectors to replace.</asp:Label>
                    </EmptyDataTemplate>
