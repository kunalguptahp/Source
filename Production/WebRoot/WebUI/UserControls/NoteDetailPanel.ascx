...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NoteDetailPanel.ascx.cs"
    Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.NoteDetailPanel" %>
		...
		<tr>
			<td align="center" colspan="2">
				<asp:HyperLink ID="lnkEdit" runat="server" SkinID="EditRecordLink"
					Visible='<%# (!this.DataItem.IsNew) && HP.ElementsCPS.Core.Security.SecurityManager.IsCurrentUserInRole(HP.ElementsCPS.Core.Security.UserRoleId.Administrator) %>'
					NavigateUrl='<%# Global.GetNoteUpdatePageUri(this.DataItem.Id, null) %>'
					/>
			</td>
		</tr>
	</table>
