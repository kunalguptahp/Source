...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationServiceLabelValueImportListPanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.ConfigurationServiceLabelValueImportListPanel" %>
<asp:Panel ID="pnlList" runat="server">
	<table border="0">
		...
		<tr>
			<td align="left" colspan="2">
				<asp:Button ID="btnCreate" SkinID="CreateItem..." runat="server" ToolTip="Create new Label Value"
							...
							<td>
								<asp:Panel ID="pnlFilterArea" runat="server" DefaultButton="btnFilter">
									<table border="1">
										<tr>
											<td align="left">
												<asp:Label ID="lblIdList" runat="server" Text="Label Value IDs:" SkinID="FilterLabel" AssociatedControlID="txtIdList"></asp:Label>
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id"
							DataNavigateUrlFormatString="~/ConfigurationService/ConfigurationServiceLabelValueImportUpdate.aspx?id={0}" />
						<asp:BoundField DataField="ItemName" HeaderText="Item Name" SortExpression="ItemName" />
						<asp:BoundField DataField="LabelName" HeaderText="Label Name" SortExpression="LabelName" />
						<asp:BoundField DataField="LabelValue" HeaderText="Label Value" SortExpression="LabelValue" />
						<asp:HyperLinkField HeaderText="Group Import" SortExpression="ConfigurationServiceGroupImportName"
							DataTextField="ConfigurationServiceGroupImportName" DataNavigateUrlFields="ConfigurationServiceGroupImportId"
...
--%>						<asp:CommandField Visible="false" ShowHeader="false" ButtonType="Button" CausesValidation="false" />
					...
					<EmptyDataTemplate>
						<asp:Label ID="lblEmptyData" runat="server" Text="Label">There are no label values found</asp:Label>
					</EmptyDataTemplate>
...
<asp:ObjectDataSource ID="odsDataSource" runat="server" EnablePaging="true" SelectMethod="ODSFetch"
	SelectCountMethod="ODSFetchCount" TypeName="HP.ElementsCPS.Data.SubSonicClient.VwMapConfigurationServiceLabelValueImportController"
