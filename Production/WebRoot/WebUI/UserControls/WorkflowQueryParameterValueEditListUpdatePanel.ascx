...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkflowQueryParameterValueEditListUpdatePanel.ascx.cs"
    Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.WorkflowQueryParameterValueEditListUpdatePanel" %>
...
<asp:Panel ID="pnlList" runat="server">
    <table border="0">
        <tr>
            ...
            <td align="right">
                <asp:CheckBox ID="chkNot" runat="server" Text="Not" Visible="false" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
