...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkflowSelectorListPanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.WorkflowSelectorListPanel" %>
				...
				<HPFx:EnhancedGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True" AutoGenerateCheckBoxColumn="true"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id"
							DataNavigateUrlFormatString="~/ConfigurationService/WorkflowSelectorUpdate.aspx?id={0}" />
...
<asp:ObjectDataSource ID="odsDataSource" runat="server" EnablePaging="true"
	SelectMethod="ODSFetch" SelectCountMethod="ODSFetchCount" TypeName="HP.ElementsCPS.Data.SubSonicClient.VwMapWorkflowSelectorController"
