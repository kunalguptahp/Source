...
{
	public partial class ConfigurationServiceLabelValueImportUpdatePanel : RecordDetailUserControl
	{
		#region Properties
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            lblError.Text = string.Format("Configuration Service Label Value Import deleted.");
		...
		{
			ConfigurationServiceLabelValueImportQuerySpecification defaultValuesSpecification = this.ConvertToExpectedType(this.DefaultValuesSpecification);
		...
		protected override void BindItem()
		{
            ...
            ConfigurationServiceLabelValueImport bindItem = this.GetDataSource();
			...
			else
			{
				try
				{
                    ...
                    this.txtItemName.Text = bindItem.ItemName;
                    this.txtLabelName.Text = bindItem.LabelName;
                    this.txtLabelValue.Text = bindItem.LabelValue;
		...
		{
            ConfigurationServiceLabelValueImport saveItem = this.GetDataSource();
			...
			saveItem.ItemName = this.txtItemName.Text.TrimToNull();
            saveItem.LabelName = this.txtLabelName.Text.TrimToNull();
            saveItem.LabelValue = this.txtLabelValue.Text.TrimToNull();
        ...
        /// <summary>
        /// Delete the ConfigurationServiceGroupLabelValueImport being edited.
        /// </summary>
        private void Delete()
        {
            ...
            {
                //get ConfigurationServiceLabelValueImport to delete
                ConfigurationServiceLabelValueImport deleteItem = this.GetDataSource();

                //delete ConfigurationServiceLabelValueImport
                deleteItem.Delete();
        ...
        protected ConfigurationServiceLabelValueImport GetDataSource()
        {
            ConfigurationServiceLabelValueImport saveItem;
            if (!this.IsNewRecord)
            {
                saveItem = ConfigurationServiceLabelValueImport.FetchByID(this.DataSourceId);
            }
            else
            {
                saveItem = new ConfigurationServiceLabelValueImport(true);
            }
            return saveItem;
        }
