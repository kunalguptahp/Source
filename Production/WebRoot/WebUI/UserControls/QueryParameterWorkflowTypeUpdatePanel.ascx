...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QueryParameterWorkflowTypeUpdatePanel.ascx.cs"
    Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.QueryParameterWorkflowTypeUpdatePanel" %>
            ...
            <td>
                <asp:Panel ID="pnlDataControls_WorkflowType" runat="server" Enabled='<%# this.IsDataModificationAllowed() %>'>
                    ...
                    <HPFx:RequiredFieldValidator ID="rfvWorkflowType" runat="server" ControlToValidate="ddlWorkflowType"
                        ErrorMessage="Please select a workflow type.<br/>" />
                </asp:Panel>
            </td>
        </tr>
        <tr>
