...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EntityTypeListPanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.EntityTypeListPanel" %>
<asp:Panel ID="pnlList" runat="server">
	<table border="0">
		...
		<tr>
			<td align="left" colspan="2">
				<asp:Button ID="btnCreate" SkinID="CreateItem..." runat="server" ToolTip="Create new Entity Type"
							...
							<td>
								<asp:Panel ID="pnlFilterArea" runat="server" DefaultButton="btnFilter">
									<table border="1">
										<tr>
											<td align="left">
												<asp:Label ID="lblIdList" runat="server" SkinID="FilterLabel" AssociatedControlID="txtIdList" Text="Entity Type IDs:"></asp:Label>
										...
										<tr>
											...
											<td align="left">
												...
												<asp:DropDownList ID="ddlStatus" SkinID="ForeignKeyColumnFilter" runat="server" ToolTip="Filter RowStatus">
												</asp:DropDownList>
											</td>
										</tr>
										<tr>
			...
			<td colspan="2">
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id" Target="_top" DataNavigateUrlFormatString="~/DataAdmin/EntityTypeUpdate.aspx?id={0}" />
						...
						<%--<asp:TemplateField HeaderText="#N" SortExpression="NoteCount">
							<ItemTemplate>
								...
								<asp:PopupControlExtender ID="ajaxhmeNoteCountPopup" runat="server" 
									...
									DynamicServiceMethod="GetDynamicContentNoteSummariesList_EntityType" DynamicServicePath="~/WebMethods.asmx" />
							</ItemTemplate>
						</asp:TemplateField>--%>
					...
					<EmptyDataTemplate>
						<asp:Label ID="lblEmptyData" runat="server" Text="Label">There are no Entity Types found</asp:Label>
					</EmptyDataTemplate>
...
<asp:ObjectDataSource ID="odsDataSource" runat="server" EnablePaging="true"
	SelectMethod="ODSFetch" SelectCountMethod="ODSFetchCount" TypeName="HP.ElementsCPS.Data.SubSonicClient.VwMapEntityTypeController"
