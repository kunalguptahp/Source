...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QueryParameterConfigurationServiceGroupTypeListPanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.QueryParameterConfigurationServiceGroupTypeListPanel" %>
<asp:Panel ID="pnlList" runat="server">
	<table border="0">
		...
		<tr>
			<td align="left">
				<asp:Button ID="btnCreate" SkinID="CreateItem..." runat="server" ToolTip="Create new Parameter/Configuration Service Group Type"
							...
							<td>
								<asp:Panel ID="pnlFilterArea" runat="server" DefaultButton="btnFilter">
									<table border="1">
										...
										<tr>
											<td align="left">
												<asp:Label ID="lblName" runat="server" Text="Parameter:" SkinID="FilterLabel" AssociatedControlID="txtName"></asp:Label>
												<asp:TextBox ID="txtName" SkinID="NameFilter" runat="server">
												</asp:TextBox>
											</td>
											<td align="left">
												<asp:Label ID="lblConfigurationServiceGroupType" runat="server" SkinID="FilterLabel" AssociatedControlID="ddlConfigurationServiceGroupType" Text="Configuration Service Group Type:"></asp:Label>
												<asp:DropDownList ID="ddlConfigurationServiceGroupType" SkinID="ForeignKeyColumnFilter" runat="server" ToolTip="Filter configuration service group type">
												</asp:DropDownList>
											</td>
										</tr>
										<tr>
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id"
							DataNavigateUrlFormatString="~/DataAdmin/QueryParameterConfigurationServiceGroupTypeUpdate.aspx?id={0}" />
						<asp:BoundField DataField="QueryParameterConfigurationServiceGroupTypeName" HeaderText="Name" SortExpression="QueryParameterConfigurationServiceGroupTypeName" />
						<asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
						<asp:BoundField DataField="Name" HeaderText="Group Type" SortExpression="Name" />
					...
					<EmptyDataTemplate>
						<asp:Label ID="lblEmptyData" runat="server" Text="Label">There are no parameter/configuration service group type(s) found</asp:Label>
					</EmptyDataTemplate>
...
<asp:ObjectDataSource ID="odsDataSource" runat="server" EnablePaging="true"
	SelectMethod="ODSFetch" SelectCountMethod="ODSFetchCount" TypeName="HP.ElementsCPS.Data.SubSonicClient.VwMapQueryParameterConfigurationServiceGroupTypeController"
