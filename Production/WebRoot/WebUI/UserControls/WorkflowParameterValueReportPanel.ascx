...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkflowParameterValueReportPanel.ascx.cs"
    Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.WorkflowParameterValueReportPanel" %>
<table border="1">
    <asp:Repeater ID="repWorkflowParameterValue" runat="server">
        <HeaderTemplate>
            <tr>
                <td align="center">
