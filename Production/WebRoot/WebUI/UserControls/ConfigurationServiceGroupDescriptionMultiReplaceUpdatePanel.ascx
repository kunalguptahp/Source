...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationServiceGroupDescriptionMultiReplaceUpdatePanel.ascx.cs"
    Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.ConfigurationServiceGroupDescriptionMultiReplaceUpdatePanel" %>
        ...
        <tr>
            <td>
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="False"
                    ...
                    <EmptyDataTemplate>
                        <asp:Label ID="lblEmptyData" runat="server" Text="Label">Please select Configuration Service Group(s) to replace.</asp:Label>
                    </EmptyDataTemplate>
