...
{
	public partial class JumpstationDomainUpdatePanel : RecordDetailUserControl
	{
...
//				this.UpdateChildListImmutableConditions();
		...
		private void ClearDataControls()
		{
			...
			this.txtDomainURL.Text = string.Empty;
		...
		{
			JumpstationDomainQuerySpecification defaultValuesSpecification = this.ConvertToExpectedType(this.DefaultValuesSpecification);
		...
		protected override void BindItem()
		{
			...
			else
			{
				try
				{
					JumpstationDomain bindItem = JumpstationDomain.FetchByID(this.DataSourceId);
					if (bindItem == null)
					{
						this.Visible = false;
						return;
				    ...
				    this.txtDomainURL.Text = bindItem.DomainURL;
		...
		{
			JumpstationDomain saveItem;
			if (this.DataSourceId != null)
			{
				saveItem = JumpstationDomain.FetchByID(this.DataSourceId);
			}
			else
			{
				saveItem = new JumpstationDomain(true);
			}

			saveItem.Name = this.txtName.Text.TrimToNull();
			saveItem.DomainURL = this.txtDomainURL.Text.TrimToNull();
