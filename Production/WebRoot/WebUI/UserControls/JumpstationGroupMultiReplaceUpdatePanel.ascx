...
<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="JumpstationGroupMultiReplaceUpdatePanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.JumpstationGroupMultiReplaceUpdatePanel" %>
<%@ Register Src="~/UserControls/JumpstationGroupDescriptionMultiReplaceUpdatePanel.ascx" TagName="JumpstationGroupDescriptionMultiReplaceUpdatePanel"
...
<asp:Panel ID="pnlEditArea" runat="server" DefaultButton="btnSave">
	<table border="1">
		<tr>
			<td>
				<asp:Label ID="lblJumpstations" runat="server" Text="Jumpstation(s):" SkinID="DataFieldLabel"></asp:Label>
			</td>
			<td>
				<asp:Panel ID="pnlQueryParameterValueMultiUpdatePanel" runat="server">
					<ElementsCPSuc:JumpstationGroupDescriptionMultiReplaceUpdatePanel ID="ucJumpstationGroupDescriptionMultiReplaceUpdate" runat="server" />
				</asp:Panel>
            </td>
		</tr>
		<tr>
			...
			<td>
				<asp:Panel ID="pnlDataControls_TagsToAdd" runat="server">
					...
					<hpfx:CustomValidator ID="cvTxtTagsToAddMaxTagCount" runat="server" ControlToValidate="txtTagsToAdd"
						Enabled="false"
						ValidationGroup="SaveJumpstationGroup" 
						ErrorMessage="Too many Tags. There is a limit of 100 Tags per jumpstation (ex. tag_01, tag_02)." 
		...
		<tr>
			<td align="center" colspan="2" >
                <asp:Button ID="btnEditGroup" Text="Edit Jumpstation(s)..." runat="server" ToolTip="Edit Jumpstation Replacements "
                    OnClick="btnEditGroup_Click" Enabled="false" />
