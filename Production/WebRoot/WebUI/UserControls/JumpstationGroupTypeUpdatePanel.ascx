...
<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="JumpstationGroupTypeUpdatePanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.JumpstationGroupTypeUpdatePanel" %>
<asp:Panel ID="pnlEditArea" runat="server" DefaultButton="btnSave">
	<table border="1">
		<tr>
			<td>
				<asp:Label ID="lblIdLabel" runat="server" Text="Jumpstation Type Id:" SkinID="DataFieldLabel" AssociatedControlID="lblIdValue"></asp:Label>
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="txtDescription" runat="server" Columns="100" Rows="8" TextMode="MultiLine"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<asp:DropDownList ID="ddlJumpstationApplication" runat="server">
				</asp:DropDownList>
				<HPFx:RequiredFieldValidator ID="rfvJumpstationApplication" runat="server" ControlToValidate="ddlJumpstationApplication"
					ErrorMessage="Please select an Application.<br/>" />
			</td>
		</tr>
		<tr>
			<td>
				<asp:Label ID="lblValidationJumpstationDomain" runat="server" Text="Validation Domain: *" SkinID="DataFieldLabel" AssociatedControlID="ddlValidationJumpstationDomain"></asp:Label>
			</td>
			<td>
				<asp:DropDownList ID="ddlValidationJumpstationDomain" runat="server">
				</asp:DropDownList>
				<HPFx:RequiredFieldValidator ID="rfvValidationJumpstationDomain" runat="server" ControlToValidate="ddlValidationJumpstationDomain"
					ErrorMessage="Please select an Validation Domain.<br/>" />
			</td>
		</tr>
		<tr>
			<td>
				<asp:Label ID="lblPublicationJumpstationDomain" runat="server" Text="Publication Domain: *" SkinID="DataFieldLabel" AssociatedControlID="ddlPublicationJumpstationDomain"></asp:Label>
			</td>
			<td>
				<asp:DropDownList ID="ddlPublicationJumpstationDomain" runat="server">
				</asp:DropDownList>
				<HPFx:RequiredFieldValidator ID="rfvPublicationJumpstationDomain" runat="server" ControlToValidate="ddlPublicationJumpstationDomain"
					ErrorMessage="Please select an Publication Domain.<br/>" />
			</td>
		</tr>
		<tr>
			<td>
