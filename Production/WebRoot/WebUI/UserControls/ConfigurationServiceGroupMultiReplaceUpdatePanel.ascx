...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationServiceGroupMultiReplaceUpdatePanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.ConfigurationServiceGroupMultiReplaceUpdatePanel" %>
<%@ Register Src="~/UserControls/ConfigurationServiceGroupDescriptionMultiReplaceUpdatePanel.ascx" TagName="ConfigurationServiceGroupDescriptionMultiReplaceUpdatePanel"
...
<asp:Panel ID="pnlEditArea" runat="server" DefaultButton="btnSave">
	<table border="1">
		<tr>
			<td>
				<asp:Label ID="lblConfigurationServiceGroup" runat="server" Text="Configuration Service Group:" SkinID="DataFieldLabel"></asp:Label>
			</td>
			<td>
				<asp:Panel ID="pnlQueryParameterValueMultiUpdatePanel" runat="server">
					<ElementsCPSuc:ConfigurationServiceGroupDescriptionMultiReplaceUpdatePanel ID="ucConfigurationServiceGroupDescriptionMultiReplaceUpdate" runat="server" />
				</asp:Panel>
            </td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center" colspan="2" >
                <asp:Button ID="btnEditGroup" Text="Edit Groups..." runat="server" ToolTip="Edit Group Replacements "
