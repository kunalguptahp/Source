...
{
	public partial class ConfigurationServiceApplicationListPanel : BaseListViewUserControl
	{
		...
		{
			ConfigurationServiceApplicationQuerySpecification query = this.ConvertToExpectedType(querySpecification);
			ConfigurationServiceApplicationQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
		...
		{
			ConfigurationServiceApplicationQuerySpecification query = new ConfigurationServiceApplicationQuerySpecification();
			GridView gv = this.Grid;
		...
		protected override void ExportData(IQuerySpecification querySpecification, string exportFormat, string filename)
		{
            ...
            this.ExportData(query, exportFormat, filename, Global.YieldDataTablesForDataExport<VwMapConfigurationServiceApplication, VwMapConfigurationServiceApplicationCollection, ConfigurationServiceApplicationQuerySpecification>(querySpecification, VwMapConfigurationServiceApplicationController.Fetch));
		}
		...
		/// </summary>
		public ConfigurationServiceApplicationQuerySpecification ConvertedQuerySpecification
		{
			get
			{
		...
		{
			this.Response.Redirect(Global.GetConfigurationServiceApplicationUpdatePageUri(applicationId, this.QuerySpecification));
		}
