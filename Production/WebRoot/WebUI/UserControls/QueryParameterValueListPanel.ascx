...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QueryParameterValueListPanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.QueryParameterValueListPanel" %>
<asp:Panel ID="pnlList" runat="server">
	<table border="0">
		...
		<tr>
			<td align="left" colspan="2">
				<asp:Button ID="btnCreate" SkinID="CreateItem..." runat="server" ToolTip="Create new Parameter Value"
							...
							<td>
								<asp:Panel ID="pnlFilterArea" runat="server" DefaultButton="btnFilter">
									<table border="1">
										...
										<tr>
											<td align="left">
												<asp:Label ID="lblParameter" runat="server" SkinID="FilterLabel" AssociatedControlID="ddlParameter" Text="Parameter:"></asp:Label>
												<asp:DropDownList ID="ddlParameter" SkinID="ForeignKeyColumnFilter" runat="server" ToolTip="Filter parameter ">
												</asp:DropDownList>
											</td>
										</tr>
										<tr>
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id"
							DataNavigateUrlFormatString="~/DataAdmin/QueryParameterValueUpdate.aspx?id={0}" />
						<asp:BoundField DataField="Name" HeaderText="Parameter Value" SortExpression="Name" />
						<asp:HyperLinkField HeaderText="Parameter" SortExpression="QueryParameterName"
							DataTextField="QueryParameterName" DataNavigateUrlFields="QueryParameterId"
							DataNavigateUrlFormatString="~/DataAdmin/QueryParameterUpdate.aspx?id={0}" />
