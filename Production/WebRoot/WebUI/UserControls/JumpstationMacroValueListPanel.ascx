...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JumpstationMacroValueListPanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.JumpstationMacroValueListPanel" %>
<asp:Panel ID="pnlList" runat="server">
	<table border="0">
		...
		<tr>
			<td align="left" colspan="2">
				<asp:Button ID="btnCreate" SkinID="CreateItem..." runat="server" ToolTip="Create new Jumpstation Macro Value"
							...
							<td>
								<asp:Panel ID="pnlFilterArea" runat="server" DefaultButton="btnFilter">
									<table border="1">
										<tr>
											<td align="left">
												<asp:Label ID="lblIdList" runat="server" Text="Parameter Value IDs:" SkinID="FilterLabel" AssociatedControlID="txtIdList"></asp:Label>
												<asp:TextBox ID="txtIdList" SkinID="IdListFilter" MaxLength="9999"
													runat="server"></asp:TextBox>
												<HPFx:RegularExpressionValidator ID="revTxtIdList" runat="server" SkinID="IntListValidator"
													ControlToValidate="txtIdList" />
										...
										<tr>
											<td align="left">
												<asp:Label ID="lblMatchName" runat="server" Text="Match Name:" SkinID="FilterLabel" AssociatedControlID="txtMatchName"></asp:Label>
												<asp:TextBox ID="txtMatchName" SkinID="NameFilter" runat="server"></asp:TextBox>
											</td>
											<td align="left">
												<asp:Label ID="lblResultValue" runat="server" Text="Result Value:" SkinID="FilterLabel" AssociatedControlID="txtResultValue"></asp:Label>
												<asp:TextBox ID="txtResultValue" SkinID="NameFilter" runat="server"></asp:TextBox>
											</td>
										</tr>
										<tr>
											<td align="left">
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="True"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="ID" SortExpression="Id" DataTextField="Id" DataNavigateUrlFields="Id"
							DataNavigateUrlFormatString="~/DataAdmin/JumpstationMacroValueUpdate.aspx?id={0}" />
						<asp:BoundField DataField="MatchName" HeaderText="Match Name" SortExpression="MatchName" />
						<asp:BoundField DataField="ResultValue" HeaderText="Result Value" SortExpression="ResultValue" />
						<asp:BoundField DataField="JumpstationMacroName" HeaderText="Macro Name" SortExpression="JumpstationMacroName" />
					...
					<EmptyDataTemplate>
						<asp:Label ID="lblEmptyData" runat="server" Text="Label">There are no macro values found</asp:Label>
					</EmptyDataTemplate>
...
<asp:ObjectDataSource ID="odsDataSource" runat="server" EnablePaging="true" SelectMethod="ODSFetch"
	SelectCountMethod="ODSFetchCount" TypeName="HP.ElementsCPS.Data.SubSonicClient.VwMapJumpstationMacroValueController"
