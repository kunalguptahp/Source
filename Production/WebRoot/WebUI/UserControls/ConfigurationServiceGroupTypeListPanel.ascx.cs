...
{
	public partial class ConfigurationServiceGroupTypeListPanel : BaseListViewUserControl
	{
		...
		{
			ConfigurationServiceGroupTypeQuerySpecification query = this.ConvertToExpectedType(querySpecification);
			ConfigurationServiceGroupTypeQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
		...
		{
			ConfigurationServiceGroupTypeQuerySpecification query = new ConfigurationServiceGroupTypeQuerySpecification();
			GridView gv = this.Grid;
		...
		protected override void ExportData(IQuerySpecification querySpecification, string exportFormat, string filename)
		{
			...
			this.ExportData(query, exportFormat, filename, Global.YieldDataTablesForDataExport<VwMapConfigurationServiceGroupType, VwMapConfigurationServiceGroupTypeCollection, ConfigurationServiceGroupTypeQuerySpecification>(query, VwMapConfigurationServiceGroupTypeController.Fetch));
		}
		...
		/// </summary>
		public ConfigurationServiceGroupTypeQuerySpecification ConvertedQuerySpecification
		{
			get
			{
		...
		{
			this.Response.Redirect(Global.GetConfigurationServiceGroupTypeUpdatePageUri(groupTypeId, this.QuerySpecification));
		}
