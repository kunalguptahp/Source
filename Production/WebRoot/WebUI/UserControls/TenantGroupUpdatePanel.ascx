...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TenantGroupUpdatePanel.ascx.cs" Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.TenantGroupUpdatePanel" %>

    <asp:Panel ID="pnlEditArea" runat="server" DefaultButton="btnSave">
	<table border="1">
		<tr>
			<td>
				<asp:Label ID="lblIdLabel" runat="server" Text="TenantGroup Id:" SkinID="DataFieldLabel" AssociatedControlID="lblIdValue"></asp:Label>
			</td>
			<td>
		...
		<tr>
		<td><asp:Label ID="lblappclient" runat="server" Text="App Clients: " SkinID="DataFieldLabel" AssociatedControlID="chkClientList"></asp:Label></td>
		<td><asp:CheckBoxList ID="chkClientList" runat="server" RepeatColumns="3" >
				</asp:CheckBoxList>
				<HPFx:CustomValidator ID="cvValidateSelectedClient" runat="server"  
                         ErrorMessage=" Please select  at least one." ClientValidationFunction="check"
                          />
