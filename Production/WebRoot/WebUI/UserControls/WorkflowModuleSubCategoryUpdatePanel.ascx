...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkflowModuleSubCategoryUpdatePanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.WorkflowModuleSubCategoryUpdatePanel" %>
		...
		<tr>
			...
			<td>
				...
				<HPFx:RegularExpressionValidator ID="revNameMinLength" runat="server" ControlToValidate="txtName"
					SkinID="MinLength2Validator" ErrorMessage="Name is too short.</br>" />
			</td>
		</tr>
		<tr>
			<td>
