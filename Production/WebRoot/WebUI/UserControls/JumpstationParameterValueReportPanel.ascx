...
<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="JumpstationParameterValueReportPanel.ascx.cs"
    Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.JumpstationParameterValueReportPanel" %>
<table border="1">
    <asp:Repeater ID="repJumpstationParameterValue" runat="server">
        <HeaderTemplate>
            <tr>
                <td align="center">
