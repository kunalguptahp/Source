...
{
	public partial class ConfigurationServiceApplicationTypeListPanel : BaseListViewUserControl
	{
		#region Overrides
		...
		{
			ConfigurationServiceApplicationTypeQuerySpecification query = this.ConvertToExpectedType(querySpecification);
			ConfigurationServiceApplicationTypeQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
		...
		{
			ConfigurationServiceApplicationTypeQuerySpecification query = new ConfigurationServiceApplicationTypeQuerySpecification();
			GridView gv = this.Grid;
		...
		{
			this.EditApplicationType(this.GetRowIdInt32(index));
		}
		...
		protected override void ExportData(IQuerySpecification querySpecification, string exportFormat, string filename)
		{
            ...
            this.ExportData(query, exportFormat, filename, Global.YieldDataTablesForDataExport<VwMapConfigurationServiceApplicationType, VwMapConfigurationServiceApplicationTypeCollection, ConfigurationServiceApplicationTypeQuerySpecification>(query, VwMapConfigurationServiceApplicationTypeController.Fetch));
		}
		...
		/// </summary>
		public ConfigurationServiceApplicationTypeQuerySpecification ConvertedQuerySpecification
		{
			get
			{
		...
		{
			this.Response.Redirect(Global.GetConfigurationServiceApplicationTypeUpdatePageUri(applicationTypeId, this.QuerySpecification));
		}
		...
		/// <returns></returns>
		public ConfigurationServiceApplicationTypeQuerySpecification ConvertToExpectedType(IQuerySpecification original)
		{
			if (original == null)
			{
				return null;
			...
			return original as ConfigurationServiceApplicationTypeQuerySpecification ?? new ConfigurationServiceApplicationTypeQuerySpecification(original);
		}
