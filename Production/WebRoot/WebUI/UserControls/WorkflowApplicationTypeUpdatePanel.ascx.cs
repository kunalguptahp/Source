...
{
	public partial class WorkflowApplicationTypeUpdatePanel : RecordDetailUserControl
	{
		#region Properties
...
//				this.UpdateChildListImmutableConditions();
		...
		{
			WorkflowApplicationTypeQuerySpecification defaultValuesSpecification = this.ConvertToExpectedType(this.DefaultValuesSpecification);
		...
		protected override void BindItem()
		{
			...
			else
			{
				try
				{
					WorkflowApplicationType bindItem = WorkflowApplicationType.FetchByID(this.DataSourceId);
					if (bindItem == null)
					{
						this.Visible = false;
						return;
		...
		{
			WorkflowApplicationType saveItem;
			if (this.DataSourceId != null)
			{
				saveItem = WorkflowApplicationType.FetchByID(this.DataSourceId);
			}
			else
			{
				saveItem = new WorkflowApplicationType(true);
			}
            ...
            Global.RemoveWorkflowApplicationTypeListControl(RowStatus.RowStatusId.Active);
		}
