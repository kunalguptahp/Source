...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JumpstationMacroDescriptionMultiReplaceUpdatePanel.ascx.cs"
    Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.JumpstationMacroDescriptionMultiReplaceUpdatePanel" %>
        ...
        <tr>
            <td>
				...
				<HPFx:PageableItemContainerGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowSorting="False"
                    ...
                    <EmptyDataTemplate>
                        <asp:Label ID="lblEmptyData" runat="server" Text="Label">Please select Jumpstation Macro(s) to replace.</asp:Label>
                    </EmptyDataTemplate>
