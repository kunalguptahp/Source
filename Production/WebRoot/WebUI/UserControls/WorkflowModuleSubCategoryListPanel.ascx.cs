...
{
	public partial class WorkflowModuleSubCategoryListPanel : BaseListViewUserControl
	{
		...
		{
			WorkflowModuleSubCategoryQuerySpecification query = this.ConvertToExpectedType(querySpecification);
			WorkflowModuleSubCategoryQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
		...
		{
			WorkflowModuleSubCategoryQuerySpecification query = new WorkflowModuleSubCategoryQuerySpecification();
			GridView gv = this.Grid;
		...
		protected override void ExportData(IQuerySpecification querySpecification, string exportFormat, string filename)
		{
			...
			this.ExportData(querySpecification, exportFormat, filename, Global.YieldDataTablesForDataExport<VwMapWorkflowModuleSubCategory, VwMapWorkflowModuleSubCategoryCollection, WorkflowModuleSubCategoryQuerySpecification>(querySpecification, VwMapWorkflowModuleSubCategoryController.Fetch));
		}
		...
		/// </summary>
		public WorkflowModuleSubCategoryQuerySpecification ConvertedQuerySpecification
		{
			get
			{
		...
		{
			this.Response.Redirect(Global.GetWorkflowModuleSubCategoryUpdatePageUri(applicationId, this.QuerySpecification));
		}
		...
		/// <returns></returns>
		public WorkflowModuleSubCategoryQuerySpecification ConvertToExpectedType(IQuerySpecification original)
		{
			if (original == null)
			{
				return null;
			...
			return original as WorkflowModuleSubCategoryQuerySpecification ?? new WorkflowModuleSubCategoryQuerySpecification(original);
		}
