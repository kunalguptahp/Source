...
<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="JumpstationApplicationUpdatePanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.JumpstationApplicationUpdatePanel" %>
<asp:Panel ID="pnlEditArea" runat="server" DefaultButton="btnSave">
	<table border="1">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtElementsKey" runat="server" MaxLength="50"></asp:TextBox>
