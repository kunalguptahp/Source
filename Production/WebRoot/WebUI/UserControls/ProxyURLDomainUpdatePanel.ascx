...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProxyURLDomainUpdatePanel.ascx.cs"
	Inherits="HP.ElementsCPS.Apps.WebUI.UserControls.ProxyURLDomainUpdatePanel" %>
<asp:Panel ID="pnlEditArea" runat="server" DefaultButton="btnSave">
	<table border="1">
		<tr>
			<td>
				<asp:Label ID="lblIdLabel" runat="server" Text="Domain Id:" SkinID="DataFieldLabel" AssociatedControlID="lblIdValue"></asp:Label>
			</td>
			<td>
		...
		<tr>
			<td>
				<asp:Label ID="lblValidationDomain" runat="server" Text="Validation Domain: *" SkinID="DataFieldLabel" AssociatedControlID="txtValidationDomain"></asp:Label>
			</td>
			<td>
				<asp:TextBox ID="txtValidationDomain" runat="server" MaxLength="256" Columns="100"></asp:TextBox>
				<HPFx:RequiredFieldValidator ID="rfvValidationDomain" runat="server" ControlToValidate="txtValidationDomain"
					ErrorMessage="Please enter a validation domain.<br/>" />
			</td>
		</tr>
		<tr>
			<td>
				<asp:Label ID="lblPublicationDomain" runat="server" Text="Publication Domain: *" SkinID="DataFieldLabel" AssociatedControlID="txtPublicationDomain"></asp:Label>
			</td>
			<td>
				<asp:TextBox ID="txtPublicationDomain" runat="server" MaxLength="256" Columns="100"></asp:TextBox>
				<HPFx:RequiredFieldValidator ID="rfvPublicationDomain" runat="server" ControlToValidate="txtPublicationDomain"
					ErrorMessage="Please enter a publication domain.<br/>" />
			</td>
		</tr>
		<tr>
			<td>
