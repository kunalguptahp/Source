...
{
	public partial class ConfigurationServiceQueryParameterValueImportListPanel : BaseListViewUserControl
	{
		...
		{
			ConfigurationServiceQueryParameterValueImportQuerySpecification query = this.ConvertToExpectedType(querySpecification);
			ConfigurationServiceQueryParameterValueImportQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
		...
		{
			ConfigurationServiceQueryParameterValueImportQuerySpecification query = new ConfigurationServiceQueryParameterValueImportQuerySpecification();
			GridView gv = this.Grid;
		...
		/// </summary>
		public ConfigurationServiceQueryParameterValueImportQuerySpecification ConvertedQuerySpecification
		{
			get
			{
		...
		{
			this.Response.Redirect(Global.GetConfigurationServiceQueryParameterValueImportUpdatePageUri(recordId, this.QuerySpecification));
		}
