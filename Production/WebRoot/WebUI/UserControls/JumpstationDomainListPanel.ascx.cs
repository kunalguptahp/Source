...
{
	public partial class JumpstationDomainListPanel : BaseListViewUserControl
	{
		...
		{
			JumpstationDomainQuerySpecification query = this.ConvertToExpectedType(querySpecification);
			JumpstationDomainQuerySpecification immutableConditions = this.ConvertToExpectedType(this.ImmutableQueryConditions);
		...
		{
			JumpstationDomainQuerySpecification query = new JumpstationDomainQuerySpecification();
			GridView gv = this.Grid;
		...
		protected override void ExportData(IQuerySpecification querySpecification, string exportFormat, string filename)
		{
			...
			this.ExportData(query, exportFormat, filename, Global.YieldDataTablesForDataExport<VwMapJumpstationDomain, VwMapJumpstationDomainCollection, JumpstationDomainQuerySpecification>(query, VwMapJumpstationDomainController.Fetch));
		}
		...
		/// </summary>
		public JumpstationDomainQuerySpecification ConvertedQuerySpecification
		{
			get
			{
		...
		{
			this.Response.Redirect(Global.GetJumpstationDomainUpdatePageUri(groupTypeId, this.QuerySpecification));
		}
		...
		/// <returns></returns>
		public JumpstationDomainQuerySpecification ConvertToExpectedType(IQuerySpecification original)
		{
			if (original == null)
			{
				return null;
			...
			return original as JumpstationDomainQuerySpecification ?? new JumpstationDomainQuerySpecification(original);
		}
