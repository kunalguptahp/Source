...
{
	public partial class ConfigurationServiceApplicationTypeUpdatePanel : RecordDetailUserControl
	{
...
//				this.UpdateChildListImmutableConditions();
		...
		{
			ConfigurationServiceApplicationTypeQuerySpecification defaultValuesSpecification = this.ConvertToExpectedType(this.DefaultValuesSpecification);
		...
		protected override void BindItem()
		{
			...
			else
			{
				try
				{
					ConfigurationServiceApplicationType bindItem = ConfigurationServiceApplicationType.FetchByID(this.DataSourceId);
					if (bindItem == null)
					{
						this.Visible = false;
						return;
		...
		{
			ConfigurationServiceApplicationType saveItem;
			if (this.DataSourceId != null)
			{
				saveItem = ConfigurationServiceApplicationType.FetchByID(this.DataSourceId);
			}
			else
			{
				saveItem = new ConfigurationServiceApplicationType(true);
			}
            ...
            Global.RemoveConfigurationServiceApplicationTypeListControl(RowStatus.RowStatusId.Active);
		}
