...
{
	public partial class JumpstationGroupSelectorCopy : BaseQuerySpecificationPage
	{
		...
		{
			return Global.GetJumpstationGroupSelectorCopyPageUri(querySpecification);
		}

		protected override string GeneratePageTitle()
		{
			return "Copy Jumpstation Selector";
		}
