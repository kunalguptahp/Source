...
{
	public partial class JumpstationGroupCopy : BaseQuerySpecificationPage
	{
		...
		{
			return Global.GetJumpstationGroupCopyPageUri(querySpecification);
		}

		protected override string GeneratePageTitle()
		{
			return "Copy Jumpstation";
		}
