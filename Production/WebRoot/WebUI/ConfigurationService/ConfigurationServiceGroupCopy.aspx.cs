...
{
	public partial class ConfigurationServiceGroupCopy : BaseQuerySpecificationPage
	{
		...
		{
			return Global.GetConfigurationServiceGroupCopyPageUri(querySpecification);
		}

		protected override string GeneratePageTitle()
		{
			return "Copy Configuration Service Group";
		}
