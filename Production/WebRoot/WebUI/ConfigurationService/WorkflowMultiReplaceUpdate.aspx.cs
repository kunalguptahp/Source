...
{
	public partial class WorkflowMultiReplaceUpdate : BaseQuerySpecificationPage
	{
		...
		{
			return Global.GetWorkflowMultiReplaceUpdatePageUri(querySpecification);
		}

		protected override string GeneratePageTitle()
		{
			return "Multi Replace Workflow";
		}
