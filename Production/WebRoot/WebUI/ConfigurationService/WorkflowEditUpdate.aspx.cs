...
{
	public partial class WorkflowEditUpdate : BaseQuerySpecificationPage
	{
		...
		{
			return Global.GetWorkflowEditUpdatePageUri(querySpecification);
		}

		protected override string GeneratePageTitle()
		{
			return Global.GenerateStandardListPageTitle("Edit Workflow", this.QuerySpecification);
		}
