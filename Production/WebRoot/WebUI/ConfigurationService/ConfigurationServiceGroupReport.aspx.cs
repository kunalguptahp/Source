...
{
	public partial class ConfigurationServiceGroupReport : BaseQuerySpecificationPage
	{
		...
		{
			return Global.GetConfigurationServiceGroupReportPageUri(querySpecification);
		}

		protected override string GeneratePageTitle()
		{
			return "Configuration Service Group Report";
		}
