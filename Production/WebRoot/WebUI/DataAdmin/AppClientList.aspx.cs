...
{
    public partial class AppClientList : BaseListPage
    {
        ...
        {
            return Global.GetAppClientListPageUri(querySpecification);
        }

        protected override string GeneratePageTitle()
        {
            return Global.GenerateStandardListPageTitle("AppClients", this.QuerySpecification);
        }
