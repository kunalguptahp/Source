...
{
	public partial class WorkflowApplicationTypeUpdate : BaseUpdatePage
	{
		...
		{
			this.Response.Redirect(Global.GetWorkflowApplicationTypeUpdatePageUri(dataSourceId, null));
		}
