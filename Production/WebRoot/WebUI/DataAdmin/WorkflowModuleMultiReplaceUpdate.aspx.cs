...
{
	public partial class WorkflowModuleMultiReplaceUpdate : BaseQuerySpecificationPage
	{
		...
		{
			return Global.GetWorkflowModuleMultiReplaceUpdatePageUri(querySpecification);
		}

		protected override string GeneratePageTitle()
		{
			return "Multi Replace Workflow Module";
		}
