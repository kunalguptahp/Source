...
{
	public partial class JumpstationMacroReport : BaseQuerySpecificationPage
	{
		...
		{
			return Global.GetJumpstationMacroReportPageUri(querySpecification);
		}

		protected override string GeneratePageTitle()
		{
			return "Report Jumpstation Macro";
		}
